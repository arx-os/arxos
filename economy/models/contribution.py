...
class Contribution(BaseModel):
    ...
    data: Dict[str, Any] = Field(..., description="Contribution data (SVGX, metadata, etc.)")
    ...
    complexity_score: Optional[float] = Field(None, description="Complexity assessment score")
...
class ContributionStatistics(BaseModel):
    ...
    average_verification_time: Optional[float] = Field(None, description="Average verification time in hours") 