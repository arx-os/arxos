...
from svgx_engine.runtime.ui_annotation_handler import (
    annotation_handler, AnnotationHandler, Annotation, AnnotationType, AnnotationVisibility
)
...
class TestAnnotationHandlerLogic:
    ...
    def test_show_annotation(self):
        ...
        assert annotation_handler.get_visibility_state("canvas1", "ann1") == AnnotationVisibility.VISIBLE
    ...
    def test_hide_annotation(self):
        ...
        assert annotation_handler.get_visibility_state("canvas1", "ann1") == AnnotationVisibility.HIDDEN
...
class TestAnnotationHandlerIntegration:
    def test_dispatch_annotation_event(self):
        ...
        assert feedback.result['handler_results'][0]['result']['annotation_id'] == 'ann1'
    ...
    def test_annotation_history(self):
        ...
        actions = [
            {"action": "create", "annotation_id": "ann1", "content": "First annotation"},
            {"action": "create", "annotation_id": "ann2", "content": "Second annotation"},
