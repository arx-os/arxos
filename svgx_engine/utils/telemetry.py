...
def create_svgx_telemetry_buffer(
    max_size: int = 10000, enable_persistence: bool = True
) -> TelemetryBuffer:
...
class TelemetryLogger:
    ...
    def log_error(
        ...
        """Log an error event."""
        metadata = {"error_type": error_type, "error_details": error_details or {}}
        self.log_event(
            event_type="error",
    ...
    def log_security(
        self, security_event: str, details: Optional[Dict[str, Any]] = None
    ):
        """Log a security event."""
        security_metadata = {"security_event": security_event, "details": details or {}}
        self.log_event(
            event_type="security",
