...
from domain.exceptions import (
    InvalidProjectError, ProjectNotFoundError, DuplicateProjectError,
...
Example:
    ...
    def execute(self, request: CreateProjectRequest) -> CreateProjectResponse:
        ...
        try:
            ...
            return CreateProjectResponse(
                success=False,
                error_message=f"Project already exists: {str(e)}"
            )
        except InvalidProjectError as e:
            return CreateProjectResponse(
                success=False,
                error_message=f"Invalid project data: {str(e)}"
            )
            ...
            if building_id:
                ...
                try:
                    ...
                    return ListProjectsResponse(
                        success=False,
                        error_message=f"Invalid project status: {status}"
                    )
            elif user_id:
