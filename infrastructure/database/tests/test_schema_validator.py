...
class TestSchemaValidator:
    ...
    def test_validate_foreign_key_ordering_invalid(
        self, validator, temp_migrations_dir
    ):
    ...
    def test_get_validation_summary(self, validator, temp_migrations_dir):
        ...
        validator.errors.append(
            ValidationError("test_error", "Test error message", "test.sql", 1)
        )
...
class TestTableInfo:
    ...
    def test_table_info_creation(self):
        ...
        table_info = TableInfo(name="users", file_path="test.sql", line_number=5)
    ...
    def test_table_info_with_foreign_keys(self):
        ...
        table_info = TableInfo(name="posts", file_path="test.sql", line_number=10)
