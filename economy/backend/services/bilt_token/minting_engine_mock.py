...
class MockBiltMintingEngine:
    ...
    async def _mint_bilt_tokens(
        ...
        try:
            ...
            self.mock_contract_state["object_mint_amounts"][
                biltobject_hash
            ] = bilt_amount
            self.mock_contract_state["object_contributors"][
                biltobject_hash
            ] = contributor_wallet
            self.mock_contract_state["object_verifiers"][
                biltobject_hash
            ] = verifier_wallet
            ...
            if (
                contributor_wallet
                not in self.mock_contract_state["contributor_objects"]
            ):
                self.mock_contract_state["contributor_objects"][contributor_wallet] = []
            self.mock_contract_state["contributor_objects"][contributor_wallet].append(
                biltobject_hash
            )
