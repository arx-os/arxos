...
mod tests {
    use super::*;
    use crate::ui::spreadsheet::types::{ColumnDefinition, CellType};
    ...
    fn test_get_cell_with_filters() {
        use crate::ui::spreadsheet::types::FilterCondition;
        ...
        if let Some(cell) = grid.get_cell_mut(0, 0) {
            cell.value = crate::ui::spreadsheet::types::CellValue::Text("test".to_string());
        }
        if let Some(cell) = grid.get_cell_mut(1, 0) {
            cell.value = crate::ui::spreadsheet::types::CellValue::Text("other".to_string());
        }
        
        // Apply filter
        filter_sort::apply_filter(
            &mut grid,
            0,
