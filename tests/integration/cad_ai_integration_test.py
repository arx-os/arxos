...
class TestCadAiIntegration(unittest.TestCase):
    ...
    def test_ai_integration_file_structure(self):
        ...
        ai_integration_path = project_root / "frontend/web/static/js/cad-ai-integration.js"

        self.assertTrue(ai_integration_path.exists(), "CAD AI integration file not found")
    ...
    def test_ai_integration_with_cad_ui(self):
        ...
        self.assertIn("this.aiIntegration = new CadAiIntegration(this, this.apiClient)", content)
