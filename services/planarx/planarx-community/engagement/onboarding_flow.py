    ...
    def _initialize_onboarding_steps(self):
        ...
        steps = [
            ...
            OnboardingStepData(
                ...
                completion_criteria={"project_created": True, "project_has_content": True},
    ...
    def _initialize_engagement_tools(self):
        ...
        tools = [
            ...
            EngagementTool(
                ...
                trigger_condition={"time_spent": 300, "step_completed": False},  # 5 minutes
                action_type="notification",
            ...
            EngagementTool(
                ...
                action_data={"type": "interactive_tutorial", "content": "project_creation_guide"}
            ),
            EngagementTool(
    ...
    def _is_step_completed(self, step: OnboardingStepData, progress_data: Dict[str, Any]) -> bool:
        ...
        try:
            for criterion, required_value in step.completion_criteria.items():
                if criterion not in progress_data or progress_data[criterion] != required_value:
                    return False
            return True
        except Exception as e:
        ...
        try:
            for dependency in step.dependencies:
                ...
                if dependency_step:
                    ...
                    if not self._is_step_completed(dependency_step, dependency_progress):
                        return False
            return True
        except Exception as e:
    ...
    async def _execute_engagement_tool(self, user_id: str, tool: EngagementTool) -> bool:
        ...
        try:
            if tool.action_type == "notification":
                await self.send_onboarding_notification(user_id, tool.name, tool.action_data)
        ...
        try:
            ...
            return {
                ...
                "engagement_distribution": {
                    ...
                    "medium": (total_users - high_engagement_users - low_engagement_users) / total_users,
