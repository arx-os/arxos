...
class TestGoSDK:
    ...
    def test_sdk_structure(self, sdk_path):
        ...
        for file_path in essential_files:
            if file_path.endswith("/"):
                assert (
                    sdk_path / file_path.rstrip("/")
                ).exists(), f"Directory {file_path} should exist"
            else:
                assert (
                    sdk_path / file_path
                ).exists(), f"Essential file {file_path} should exist"
    ...
    def test_go_mod_structure(self, sdk_path):
        ...
        required_components = ["module", "go ", "require"]
    ...
    def test_api_structure(self, sdk_path):
        ...
        for package in api_packages:
            ...
            package_files = [f"{package}.go", "README.md"]

            for file_name in package_files:
                file_path = package_dir / file_name
                assert (
                    file_path.exists()
                ), f"Package file {file_name} should exist in {package}"
    ...
    def test_compilation(self, sdk_path):
        ...
        try:
            ...
            result = subprocess.run(
                ["go", "build", "."], cwd=sdk_path, capture_output=True, text=True
            )
    ...
    def test_vet(self, sdk_path):
        ...
        try:
            # Run go vet
            result = subprocess.run(
                ["go", "vet", "./..."], cwd=sdk_path, capture_output=True, text=True
            )
        ...
        if test_dir.exists():
            ...
            for test_file in test_files:
                ...
                if test_path.exists():
                    ...
                    assert (
                        "func Test" in content
                    ), f"Test file {test_file} should have test functions"
    ...
    def test_export_structure(self, sdk_path):
        ...
        main_files = ["client.go", "configuration.go"]
        ...
        for file_name in main_files:
            ...
            if file_path.exists():
                ...
                assert (
                    "func (" in content or "type " in content
                ), f"File {file_name} should have exports"
