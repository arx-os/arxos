    ...
    if isinstance(timestamp, str):
        try:
            ...
            try:
                ...
                logger.warning(
                    "timestamp_parse_failed", timestamp=timestamp, error=str(e)
                )
                return None
...
def format_timestamp(dt: datetime, format_type: str = "iso") -> str:
    ...
    if format_type == "iso":
        ...
        logger.warning("unknown_timestamp_format", format_type=format_type)
        return dt.isoformat()


def add_timestamp_to_dict(
    data: Dict[str, Any], key: str = "timestamp"
) -> Dict[str, Any]:
    """
...
def parse_duration(duration_str: str) -> Optional[timedelta]:
    ...
    try:
        ...
        logger.warning("duration_parse_failed", duration_str=duration_str)
        return None
