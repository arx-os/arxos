...
class BuildingUpdated(DomainEvent):
    ...
    def __init__(
        self, building_id: str, updated_fields: List[str], updated_by: str, **kwargs
    ):
        super().__init__(**kwargs)
        self.building_id = building_id
...
class FloorUpdated(DomainEvent):
    ...
    def __init__(
        self, floor_id: str, updated_fields: List[str], updated_by: str, **kwargs
    ):
        super().__init__(**kwargs)
        self.floor_id = floor_id
        self.updated_fields = updated_fields
...
class RoomUpdated(DomainEvent):
    ...
    def __init__(
        self, room_id: str, updated_fields: List[str], updated_by: str, **kwargs
    ):
        super().__init__(**kwargs)
        self.room_id = room_id
        self.updated_fields = updated_fields
...
class DeviceUpdated(DomainEvent):
    ...
    def __init__(
        self, device_id: str, updated_fields: List[str], updated_by: str, **kwargs
    ):
        super().__init__(**kwargs)
        self.device_id = device_id
        self.updated_fields = updated_fields
...
class UserUpdated(DomainEvent):
    ...
    def __init__(
        self, user_id: str, updated_fields: List[str], updated_by: str, **kwargs
    ):
        super().__init__(**kwargs)
        self.user_id = user_id
        self.updated_fields = updated_fields
...
class UserRoleChanged(DomainEvent):
    ...
    def __init__(
        self, user_id: str, old_role: str, new_role: str, changed_by: str, **kwargs
    ):
        super().__init__(**kwargs)
        self.user_id = user_id
...
class ProjectUpdated(DomainEvent):
    ...
    def __init__(
        self, project_id: str, updated_fields: List[str], updated_by: str, **kwargs
    ):
        super().__init__(**kwargs)
        self.project_id = project_id
        self.updated_fields = updated_fields
...
class EventBus:
    ...
    def get_events_by_aggregate_id(self, aggregate_id: str) -> List[DomainEvent]:
        ...
        return [
            ...
            if event.get_aggregate_id() == aggregate_id
        ]
