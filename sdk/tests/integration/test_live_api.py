...
class TestLiveAPI:
        ...
        try:
            ...
            if create_response.status_code == 201:
                ...
                if building_response.status_code == 201:
                    ...
                    assert retrieved_project["id"] == project_id, "Should return correct project"
        ...
        try:
            ...
            if wall_response.status_code == 201:
                ...
                if room_response.status_code == 201:
                    ...
                    assert objects_response.status_code == 200, "Should retrieve BIM objects"
    ...
    def test_asset_management_workflow(self, api_config, auth_token):
        ...
        try:
            ...
            if asset_response.status_code == 201:
                ...
                assert retrieved_asset["status"] == "maintenance", "Should reflect update"
    ...
    def test_svg_parser_integration(self, api_config):
        ...
        try:
            ...
            health_response = requests.get(
                f"{api_config['svg_parser_url']}/health",
                timeout=10
            )
        ...
        try:
            ...
            if health_response.status_code == 200:
                ...
                connections_response = requests.get(
                    f"{api_config['cmms_url']}/cmms/connections",
                    timeout=10
                )
                
                assert connections_response.status_code == 200, "Should retrieve CMMS connections"
    ...
    def test_database_infrastructure(self, api_config):
        ...
        try:
            ...
            health_response = requests.get(
                f"{api_config['database_url']}/health",
                timeout=10
            )
            ...
            if health_response.status_code == 200:
                ...
                status_response = requests.get(
                    f"{api_config['database_url']}/database/status",
                    timeout=10
                )
                
                assert status_response.status_code == 200, "Should retrieve database status"
    ...
    def test_error_handling(self, api_config):
        ...
        try:
            ...
            invalid_endpoint_response = requests.get(
                f"{api_config['base_url']}/api/invalid-endpoint",
                timeout=10
            )
            ...
            assert invalid_data_response.status_code in [400, 401], "Should reject invalid data"
    ...
    def test_performance_metrics(self, api_config):
        ...
        try:
            ...
            assert response_time < 5.0, f"Response time should be under 5 seconds: {response_time}"
            ...
            assert concurrent_time < 10.0, f"Concurrent requests should complete under 10 seconds: {concurrent_time}"
