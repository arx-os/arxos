...
mod tests {
    ...
    fn test_export_csv_basic() {
        ...
        let rows = vec![
            vec![CellValue::Text("Equipment1".to_string()), CellValue::Text("HVAC".to_string())],
            vec![CellValue::Text("Equipment2".to_string()), CellValue::Text("Electrical".to_string())],
        ];
    ...
    fn test_export_csv_formatting() {
        ...
        let rows = vec![
            vec![CellValue::Number(42.5), CellValue::Boolean(true)],
        ];
    ...
    fn test_format_cell_for_csv() {
        assert_eq!(format_cell_for_csv(&CellValue::Text("test".to_string())), "test");
