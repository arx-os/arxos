...
func (e *EnergyLayer) Render(viewport abim.Viewport) [][]rune {
...
func (e *EnergyLayer) renderFlowEdge(buffer [][]rune, edgeID string, state energy.EdgeState, vp abim.Viewport) {
...
func (e *EnergyLayer) renderFlowNode(buffer [][]rune, nodeID string, state energy.NodeState, vp abim.Viewport) {
...
func (e *EnergyLayer) markDirty() {
	...
	e.dirty = []abim.Region{{0, 0, 1000, 1000}}
}
...
func (e *EnergyLayer) SetDirty(regions []abim.Region) {
	e.dirty = regions
}
...
func (e *EnergyLayer) RenderFlowPath(buffer [][]rune, points []energy.FlowPoint, vp abim.Viewport) {
