...
1. **No frameworks**: Pure Rust + SQLite
2. **No internet**: Everything runs locally and offline
...
# Setup complete - no additional targets needed
...
| Performance issues | Optimize algorithms, use native code |
...
Week 5:  Mobile native integration
