...
impl UndoRedoManager {
    ...
    /// Record an operation
    pub fn record_operation(&mut self, row: usize, col: usize, old_value: CellValue, new_value: CellValue) {
...
mod tests {
    ...
    fn test_undo_multiple() {
        ...
        manager.record_operation(1, 0, CellValue::Empty, CellValue::Text("second".to_string()));
    ...
    fn test_undo_after_edit_clears_redo() {
        ...
        manager.record_operation(0, 0, CellValue::Empty, CellValue::Text("second".to_string()));
    ...
    fn test_undo_applies_to_grid() {
        ...
        // Record change
        manager.record_operation(0, 0, CellValue::Text("old".to_string()), CellValue::Text("new".to_string()));
