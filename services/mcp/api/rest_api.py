...
class MCPValidationAPI:
    ...
    def _register_routes(self):
        ...
        async def get_available_codes():
            ...
            try:
                ...
                return {"codes": codes, "timestamp": datetime.now().isoformat()}
    ...
    def _validate_incremental(
        self, building_model: BuildingModel, changed_objects: List[str]
    ) -> Dict[str, Any]:
        ...
        changed_objs = [
            obj for obj in building_model.objects if obj.object_id in changed_objects
        ]
        ...
        return {"highlights": highlights, "warnings": warnings, "errors": errors}
