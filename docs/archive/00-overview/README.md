...
> Note: Arxos is RF-only and terminal-first. No web servers are part of the core runtime; all interaction happens locally via the terminal and RF mesh.
...
- Runs on local devices with native code
