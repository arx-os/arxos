...
Example:
    ...
    def add_constraint(self, constraint_type: ConstraintType, entities: List[str],
        ...
        try:
            if constraint_type == ConstraintType.DISTANCE:
                ...
                constraint = self.constraint_system.create_coincident_constraint(entities)
            else:
    ...
    def add_dimension(self, dimension_type: DimensionType, start_point: PrecisionPoint,
        ...
        try:
            if dimension_type in [DimensionType.LINEAR_HORIZONTAL, DimensionType.LINEAR_VERTICAL, DimensionType.LINEAR_ALIGNED]:
    ...
    def add_component_to_assembly(self, assembly_id: str, component_data: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            component = Component(
                ...
                position=PrecisionPoint(component_data['position']['x'], component_data['position']['y']),
