...
class CreateBuildingWithFloorsUseCase:
    ...
    def execute(
        self, building_request: CreateBuildingRequest, floors_data: List[Dict[str, Any]]
    ) -> CreateBuildingResponse:
        ...
        try:
            ...
            return CreateBuildingResponse(
                success=False, error_message=f"Duplicate floor: {str(e)}"
            )
...
class AddRoomToFloorUseCase:
    ...
    def execute(
        ...
        try:
            ...
            if not floor:
                return {"success": False, "error_message": "Floor not found"}
            ...
            return {"success": False, "error_message": f"Room already exists: {str(e)}"}
...
class UpdateBuildingStatusUseCase:
    ...
    def execute(
        self, building_id: str, new_status: str, updated_by: str
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if not building:
                return {"success": False, "error_message": "Building not found"}
            ...
            for floor in floors:
                try:
                    ...
                    new_floor_status = floor_status_mapping.get(
                        new_building_status, FloorStatus.PLANNED
                    )
            ...
            for room in rooms:
                try:
                    ...
                    new_room_status = room_status_mapping.get(
                        new_building_status, RoomStatus.PLANNED
                    )
