...
from mod.user_roles import (
    governance_user_manager,
    UserProfile,
    UserRole
)
...
class TestGovernanceBoard:
    ...
    def test_role_permissions(self):
        ...
        chair_permissions = governance_board.role_permissions[RoleType.CHAIR].permissions
        ...
        treasurer_permissions = governance_board.role_permissions[RoleType.TREASURER].permissions
        ...
        member_permissions = governance_board.role_permissions[RoleType.BOARD_MEMBER].permissions
    ...
    def test_has_permission(self):
        ...
        # Test permissions
        assert governance_board.has_permission("user-123", PermissionType.CREATE_PROPOSAL)
        assert governance_board.has_permission("user-123", PermissionType.VETO_PROPOSAL)
        assert governance_board.has_permission("user-123", PermissionType.OVERRIDE_FUND_RELEASE)
        
        # Test non-member
        assert not governance_board.has_permission("user-456", PermissionType.CREATE_PROPOSAL)
...
class TestVotingEngine:
    ...
    def test_unauthorized_vote(self):
        ...
        with pytest.raises(ValueError, match="User unauthorized-user is not an active board member"):
...
class TestGovernanceUserManager:
    ...
    def test_assign_role_insufficient_experience(self):
        ...
        with pytest.raises(ValueError, match="User does not meet experience requirement"):
    ...
    def test_get_governance_candidates(self):
        ...
        candidates = governance_user_manager.get_governance_candidates(RoleType.TREASURER)
