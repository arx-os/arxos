...
from svgx_engine.runtime.event_driven_behavior_engine import event_driven_behavior_engine, EventDrivenBehaviorEngine
from svgx_engine.runtime.advanced_state_machine import advanced_state_machine, AdvancedStateMachine
from svgx_engine.runtime.conditional_logic_engine import conditional_logic_engine, ConditionalLogicEngine
from svgx_engine.runtime.performance_optimization_engine import performance_optimization_engine, PerformanceOptimizationEngine
...
from svgx_engine.runtime.ui_navigation_handler import navigation_handler, NavigationHandler
from svgx_engine.runtime.ui_annotation_handler import annotation_handler, AnnotationHandler

# Time-based and Rule Systems
from svgx_engine.runtime.time_based_trigger_system import time_based_trigger_system, TimeBasedTriggerSystem
from svgx_engine.runtime.advanced_rule_engine import advanced_rule_engine, AdvancedRuleEngine

# Behavior Management and Animation
from svgx_engine.runtime.behavior_management_system import behavior_management_system, BehaviorManagementSystem
from svgx_engine.runtime.animation_behavior_system import animation_behavior_system, AnimationBehaviorSystem
...
from svgx_engine.runtime.conditional_logic_engine import Condition, LogicType, ComparisonOperator
from svgx_engine.runtime.performance_optimization_engine import CacheEntry, CacheStrategy
from svgx_engine.runtime.ui_navigation_handler import ViewportState
from svgx_engine.runtime.ui_annotation_handler import Annotation, AnnotationType, AnnotationVisibility
from svgx_engine.runtime.time_based_trigger_system import Trigger, TriggerType, TriggerStatus
from svgx_engine.runtime.advanced_rule_engine import Rule, RuleCondition, RuleAction, RuleResult, RuleType, RulePriority, RuleStatus
from svgx_engine.runtime.behavior_management_system import Behavior, BehaviorMetadata, BehaviorValidation, BehaviorVersion, BehaviorType, BehaviorStatus, ValidationLevel
from svgx_engine.runtime.animation_behavior_system import Animation, AnimationConfig, AnimationState, Keyframe, AnimationType, EasingFunction, AnimationStatus, AnimationDirection

# Error Classes
from svgx_engine.utils.errors import SVGXError, ValidationError, BehaviorError, StateError, OptimizationError, MemoryError
...
def initialize_core_systems():
    ...
    try:
        ...
        register_instance("performance_optimization_engine", performance_optimization_engine)
