...
func (m *MockRoomRepository) GetEquipment(ctx context.Context, roomID string) ([]*domain.Equipment, error) {
...
func (m *MockVersionRepository) Create(ctx context.Context, version *building.Version) error {
	args := m.Called(ctx, version)
	return args.Error(0)
}

func (m *MockVersionRepository) GetByID(ctx context.Context, id string) (*building.Version, error) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockVersionRepository) GetByRepositoryAndTag(ctx context.Context, repoID, tag string) (*building.Version, error) {
	args := m.Called(ctx, repoID, tag)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*building.Version), args.Error(1)
...
func (m *MockVersionRepository) ListByRepository(ctx context.Context, repoID string) ([]building.Version, error) {
...
func (m *MockVersionRepository) GetLatest(ctx context.Context, repoID string) (*building.Version, error) {
	args := m.Called(ctx, repoID)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockVersionRepository) Update(ctx context.Context, version *building.Version) error {
	args := m.Called(ctx, version)
	return args.Error(0)
}
...
func TestRollbackService_ValidateRollback_CountMismatch(t *testing.T) {
	...
	snapshot := &building.Snapshot{
		Metadata: building.SnapshotMetadata{
			FloorCount:     3, // Expect 3, got 1
			EquipmentCount: 5, // Expect 5, got 1
		},
	}
