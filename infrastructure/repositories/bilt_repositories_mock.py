...
from domain.repositories import (
    ContributionRepository, RevenueRepository, DividendRepository, VerificationRepository
)
...
class MockSQLAlchemyContributionRepository(ContributionRepository):
    ...
    def get_by_contributor(self, contributor_wallet: str) -> List[Dict[str, Any]]:
        ...
        try:
            return [
                data for data in self.mock_data.values()
...
class MockSQLAlchemyRevenueRepository(RevenueRepository):
    ...
    def get_revenue_for_distribution(self, distribution_id: str) -> List[Dict[str, Any]]:
