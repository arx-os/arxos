...
func TestLastWriteWinsResolver(t *testing.T) {
	...
	conflict := &Conflict{
		...
		LocalChange: &Change{
			...
			Entity:    "building",
			EntityID:  "building-001",
			Data:      map[string]any{"name": "Local Building"},
		...
		RemoteChange: &Change{
			...
			Entity:    "building",
			EntityID:  "building-001",
			Data:      map[string]any{"name": "Remote Building"},
			Timestamp: now,
			UserID:    "user2",
			Version:   2,
		},
		LocalData:  map[string]any{"name": "Local Building"},
		RemoteData: map[string]any{"name": "Remote Building"},
	}
...
func TestMergeResolver(t *testing.T) {
	...
	conflict := &Conflict{
		...
		LocalChange: &Change{
			...
			Entity:    "building",
			EntityID:  "building-001",
			Data:      map[string]any{"name": "Local Building", "address": "123 Local St"},
			Timestamp: now.Add(-time.Hour),
			UserID:    "user1",
			Version:   1,
		},
		RemoteChange: &Change{
			...
			Entity:    "building",
			EntityID:  "building-001",
			Data:      map[string]any{"name": "Remote Building", "description": "Remote description"},
			Timestamp: now,
			UserID:    "user2",
			Version:   2,
		},
		LocalData:  map[string]any{"name": "Local Building", "address": "123 Local St"},
		RemoteData: map[string]any{"name": "Remote Building", "description": "Remote description"},
	}
