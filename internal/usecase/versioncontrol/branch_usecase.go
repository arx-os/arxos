...
func (uc *BranchUseCase) CreateBranch(
	ctx context.Context,
	req versioncontrol.CreateBranchRequest,
	...
	branch := &versioncontrol.Branch{
		...
		Protected:         branchType == versioncontrol.BranchTypeMain, // Main is protected by default
		RequiresReview:    branchType == versioncontrol.BranchTypeMain || branchType == versioncontrol.BranchTypeRelease,
		AutoDeleteOnMerge: branchType == versioncontrol.BranchTypeIssue || branchType == versioncontrol.BranchTypeScan,
...
func (uc *BranchUseCase) ListBranches(
	...
	filter versioncontrol.BranchFilter,
) ([]*versioncontrol.Branch, error) {
...
func (uc *BranchUseCase) GetDefaultBranch(
	ctx context.Context,
	repositoryID types.ID,
) (*versioncontrol.Branch, error) {
	return uc.branchRepo.GetDefaultBranch(repositoryID)
}
...
func (uc *BranchUseCase) CheckoutBranch(
	ctx context.Context,
	req versioncontrol.CheckoutBranchRequest,
) (*versioncontrol.Branch, error) {
