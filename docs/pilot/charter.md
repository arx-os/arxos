...
**Site north star (full §1.1a):** see `docs/process/horizon-b-roadmap.md` — this charter
...
- Identity rules: `docs/reference/identity.md`. Limitations: `docs/reference/ifc-limitations.md`.
...
Complete **`docs/pilot/data-classification.md`** and summarize here:
...
| Classification form completed (`docs/pilot/data-classification.md`) | [ ] |
...
| Supported workflow is only `docs/pilot/supported-workflow.md` | [ ] |
...
| Criterion | Y/N |
| :--- | :---: |
| Second person completed walkthrough (`docs/pilot/second-person-checklist.md`) | |
...
**Related:** [l1-supported-workflow.md](supported-workflow.md) · [second-person-checklist.md](second-person-checklist.md) · [field-handoff.md](field-handoff.md) · [`arxos_manifest.md`](../../arxos_manifest.md) §1.6
