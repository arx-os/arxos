...
class TestSVGXIntegration:
    ...
    def test_get_session_info(self):
        ...
        try:
            response = requests.get(
                f"{self.base_url}/session/{self.test_session_id}/info"
            )
            assert response.status_code == 200
    ...
    async def test_websocket_connection(self):
        ...
        try:
            ws_url = (
                f"{self.websocket_url}/{self.test_session_id}/{self.test_client_id}"
            )
    ...
    def test_real_time_update(self):
        ...
        try:
            ...
            response = requests.post(
                f"{self.base_url}/session/{self.test_session_id}/update", json=payload
            )
            assert response.status_code == 200
    ...
    def test_export_drawing(self):
        ...
        try:
            ...
            response = requests.post(
                f"{self.base_url}/session/{self.test_session_id}/export", json=payload
            )
            assert response.status_code == 200
