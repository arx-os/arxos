...
- `handle_status` in `crates/arxui/crates/arxui/src/commands/mod.rs:58`
- `crates/arxui/crates/arxui/src/commands/status_dashboard.rs` - Interactive dashboard
- `crates/arxui/crates/arxui/src/commands/git_ops.rs` - Git status handling
...
- `crates/arxui/crates/arxui/src/commands/validate.rs` - Validation handler
