...
func (f *FailureLayer) Render(viewport abim.Viewport) [][]rune {
...
func (f *FailureLayer) renderRiskZone(buffer [][]rune, zone RiskZone, vp abim.Viewport) {
...
func (f *FailureLayer) renderFailureEvent(buffer [][]rune, failure FailureEvent, vp abim.Viewport) {
...
func (f *FailureLayer) renderFailureRadius(buffer [][]rune, centerX, centerY, radius int, failure FailureEvent, vp abim.Viewport) {
...
func (f *FailureLayer) renderPropagationPath(buffer [][]rune, failure FailureEvent, vp abim.Viewport) {
...
func (f *FailureLayer) renderPropagationLine(buffer [][]rune, x1, y1, x2, y2 int, impact float64, vp abim.Viewport) {
...
func (f *FailureLayer) SetDirty(regions []abim.Region) {
	f.dirty = regions
}

func (f *FailureLayer) markDirty() {
	// Mark entire viewport as dirty
	f.dirty = []abim.Region{{0, 0, 1000, 1000}}
}
