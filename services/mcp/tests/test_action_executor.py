...
class TestActionExecutor:
    ...
    def test_formula_evaluation_simple(self):
        ...
        action = RuleAction(
            type=ActionType.CALCULATION, formula="area + 10", unit="sqft"
        )
    ...
    def test_formula_evaluation_with_variables(self):
        ...
        action = RuleAction(
            type=ActionType.CALCULATION, formula="area * count", unit="sqft"
        )
    ...
    def test_formula_evaluation_error_handling(self):
        ...
        action = RuleAction(
            type=ActionType.CALCULATION, formula="invalid_formula", unit="units"
        )
    ...
    def test_formula_with_division_by_zero(self):
        ...
        action = RuleAction(
            type=ActionType.CALCULATION, formula="area / 0", unit="units"
        )
    ...
    def test_formula_with_invalid_syntax(self):
        ...
        action = RuleAction(type=ActionType.CALCULATION, formula="area +", unit="units")
