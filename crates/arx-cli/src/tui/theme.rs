...
use crate::tui::theme_manager::ThemeManager;
...
impl From<&arx::yaml::EquipmentStatus> for StatusColor {
    fn from(status: &arx::yaml::EquipmentStatus) -> Self {
        match status {
            arx::yaml::EquipmentStatus::Healthy => StatusColor::Healthy,
            arx::yaml::EquipmentStatus::Warning => StatusColor::Warning,
            arx::yaml::EquipmentStatus::Critical => StatusColor::Critical,
            arx::yaml::EquipmentStatus::Unknown => StatusColor::Unknown,
        }
    }
}
