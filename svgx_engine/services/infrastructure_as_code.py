...
class DigitalElement:
    ...
    cad_primitives: List[Union[Line, Arc, Circle, Rectangle, Polyline]] = field(
    ...
    def add_cad_primitive(
        self, primitive: Union[Line, Arc, Circle, Rectangle, Polyline]
    ):
    ...
    def add_constraint(self, constraint: Constraint):
        ...
        self.updated_at = datetime.now()
        log_info(
            f"Added constraint {constraint.constraint_type.value} to element {self.id}"
        )
...
class InfrastructureAsCodeService:
    ...
    def create_cad_element(
        self,
        element_type: ElementType,
        primitives: List[Union[Line, Arc, Circle, Rectangle, Polyline]],
        **kwargs,
    ) -> DigitalElement:
    ...
    def add_constraint_to_element(
        self, element_id: str, constraint: Constraint
    ) -> bool:
                ...
                "elements": [
                    {
                        ...
                        "position": [
                            float(elem.position_x),
                            float(elem.position_y),
                            float(elem.position_z),
                        ],
                        "dimensions": [
                            float(elem.width),
                            float(elem.height),
