...
class TestPerformance:
    ...
    def test_small_model_performance(self):
        ...
        assert execution_time < 1.0, f"Execution time {execution_time:.3f}s exceeds 1.0s limit"
    ...
    def test_medium_model_performance(self):
        ...
        # Performance assertions
        assert execution_time < 5.0, f"Execution time {execution_time:.3f}s exceeds 5.0s limit"
        assert memory_used < 500, f"Memory usage {memory_used:.1f}MB exceeds 500MB limit"
        assert report is not None
        
        print(f"Medium model (1,000 objects): {execution_time:.3f}s, {memory_used:.1f}MB")
    ...
    def test_large_model_performance(self):
        ...
        print(f"Large model (10,000 objects): {execution_time:.3f}s, {memory_used:.1f}MB")
    ...
    def test_cache_performance(self):
        ...
        print(f"Cache performance: {first_execution_time:.3f}s -> {second_execution_time:.3f}s")
    ...
    def test_concurrent_validations(self):
        ...
        assert efficiency_ratio < num_concurrent * 2, \
            f"Concurrent efficiency ratio {efficiency_ratio:.2f} is too high"
        
        print(f"Concurrent validations: {total_time:.3f}s total, {avg_individual_time:.3f}s avg per validation")
    ...
    def test_rule_complexity_performance(self):
        ...
        # Performance assertions
        assert execution_time < 60.0, f"Complex rules execution time {execution_time:.3f}s exceeds 60.0s limit"
        assert report is not None
    ...
    def test_memory_profiling(self):
        ...
        if memory_samples:
            ...
            assert max_memory < 2000, f"Peak memory usage {max_memory:.1f}MB exceeds 2GB limit"
            assert avg_memory < 1500, f"Average memory usage {avg_memory:.1f}MB exceeds 1.5GB limit"
    ...
    def test_scalability_benchmark(self):
        ...
        for size in model_sizes:
            ...
            print(f"Size {size}: {execution_time:.3f}s, {memory_mb:.1f}MB, {results[size]['objects_per_second']:.0f} obj/s")
