        ...
        try:
            ...
            if not request.name or len(request.name.strip()) == 0:
                return CreateRoomResponse(
                    success=False, error_message="Room name is required"
                )

            if not request.room_number or len(request.room_number.strip()) == 0:
                return CreateRoomResponse(
                    success=False, error_message="Room number is required"
                )

            if not request.floor_id or len(request.floor_id.strip()) == 0:
                return CreateRoomResponse(
                    success=False, error_message="Floor ID is required"
                )
            ...
            return CreateRoomResponse(
                success=False, error_message=f"Room already exists: {str(e)}"
            )
        except InvalidRoomError as e:
            return CreateRoomResponse(
                success=False, error_message=f"Invalid room data: {str(e)}"
            )
        except Exception as e:
            return CreateRoomResponse(
                success=False, error_message=f"Failed to create room: {str(e)}"
            )
        ...
        try:
            ...
            if not request.room_id or len(request.room_id.strip()) == 0:
                return UpdateRoomResponse(
                    success=False, error_message="Room ID is required"
                )
            ...
            if not room:
                return UpdateRoomResponse(success=False, error_message="Room not found")
            ...
            if request.room_number is not None:
                if len(request.room_number.strip()) == 0:
                    return UpdateRoomResponse(
                        success=False, error_message="Room number cannot be empty"
                    )
            ...
            return UpdateRoomResponse(
                success=False, error_message=f"Failed to update room: {str(e)}"
            )
...
class GetRoomUseCase:
    ...
    def execute(self, room_id: str) -> GetRoomResponse:
        ...
        try:
            ...
            if not room:
                return GetRoomResponse(success=False, error_message="Room not found")
            ...
            return GetRoomResponse(success=True, room=room_dict)

        except Exception as e:
            return GetRoomResponse(
                success=False, error_message=f"Failed to get room: {str(e)}"
            )
...
class ListRoomsUseCase:
    ...
    def execute(
        ...
        try:
            ...
            if floor_id:
                ...
                try:
                    ...
                    return ListRoomsResponse(
                        success=False, error_message=f"Invalid room status: {status}"
                    )
            else:
            ...
            return ListRoomsResponse(
                success=False, error_message=f"Failed to list rooms: {str(e)}"
            )
...
class DeleteRoomUseCase:
    ...
    def execute(self, room_id: str) -> DeleteRoomResponse:
        ...
        try:
            ...
            if not room:
                return DeleteRoomResponse(success=False, error_message="Room not found")
            ...
            return DeleteRoomResponse(
                success=False, error_message=f"Failed to delete room: {str(e)}"
            )
