...
class TestTypeScriptSDK:
    ...
    def test_package_json_structure(self, sdk_path):
        ...
        for dep in required_deps:
            assert dep in data.get(
                "dependencies", {}
            ), f"Should include {dep} dependency"
    ...
    def test_typescript_config(self, sdk_path):
        ...
        assert (
            "declaration" in config["compilerOptions"]
    ...
    def test_compilation(self, sdk_path):
        ...
        try:
            ...
            result = subprocess.run(
                ["npx", "tsc", "--noEmit"], cwd=sdk_path, capture_output=True, text=True
            )
        ...
        if utils_dir.exists():
            ...
            for utils_file in utils_files:
                ...
                if utils_path.exists():
                    ...
                    ), f"Utility file {utils_file} should have functions"
