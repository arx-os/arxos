...
class InterferenceChecker:
    ...
    def _bounding_boxes_overlap(
        self, bbox1: Dict[str, PrecisionPoint], bbox2: Dict[str, PrecisionPoint]
    ) -> bool:
    ...
    def _detailed_interference_check(
...
class AssemblyValidator:
    ...
    def validate_assembly(self, assembly: Assembly) -> bool:
        ...
        try:
            ...
            interference_pairs = self.interference_checker.check_assembly_interference(
                assembly
            )
    ...
    def _validate_constraint(
        self, constraint: AssemblyConstraint, assembly: Assembly
    ) -> bool:
        """Validate constraint"""
        try:
