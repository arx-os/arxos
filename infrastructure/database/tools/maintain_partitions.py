...
def main():
    ...
    if success:
        ...
        if maintainer.maintenance_results:
            ...
            print("="*60)
            print(f"Total operations: {maintainer.maintenance_results.total_operations}")
            ...
            print(f"Partitions created: {maintainer.maintenance_results.partitions_created}")
            print(f"Partitions dropped: {maintainer.maintenance_results.partitions_dropped}")
            print("\nRecommendations:")
