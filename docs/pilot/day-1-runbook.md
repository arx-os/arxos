...
| `file too large` / `ARX_MAX_IFC_BYTES` | R6 refuse | See [resource-limits.md](../reference/resource-limits.md); raise env only with headroom; log §C |
...
**Related:** [l1-supported-workflow.md](supported-workflow.md) · [resource-limits.md](../reference/resource-limits.md) · [ifc-limitations.md](../reference/ifc-limitations.md)
