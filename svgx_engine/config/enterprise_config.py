    ...
    def validate_environment(cls, v):
        ...
        if v == EnvironmentType.PRODUCTION:
            if cls.security_level == SecurityLevel.LOW:
                raise ValueError(
                    "Production environment requires HIGH or CRITICAL security level"
                )
        return v
...
class EnterpriseConfigManager:
    ...
    def load_configuration(self) -> SVGXEnterpriseConfig:
        ...
        merged_config = self._merge_configurations(
            file_config, env_config, secrets_config
        )
    ...
    def get_configuration_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "compliance_frameworks": [
                f.value for f in self.config.compliance.frameworks
            ],
