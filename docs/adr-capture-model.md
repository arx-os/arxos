...
| **Complements** | Decision 9 ([`adr-web-demotion.md`](./adr-web-demotion.md)) — web landing only; native iOS future |
| **Does not supersede** | IFC-only BIM · agent as bridge · TUI default · L1 field packet · Horizon C freeze |
| **Related** | [`adr.md`](./adr.md) Decision 10 · [`../arxos_manifest.md`](../arxos_manifest.md) §1.1a · `review_status` / LiDAR proposed gates |
