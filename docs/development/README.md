...
**New developer?** → Start with [Developer Onboarding](./DEVELOPER_ONBOARDING.md)  
**Need to optimize?** → See [Performance Guide](./PERFORMANCE_GUIDE.md)  
**Looking for benchmarks?** → See [Benchmarks](./BENCHMARKS.md)  
**Adding rendering features?** → See [render/](./render/)  
**Updating docs?** → See [Rustdoc Guide](./RUSTDOC_GUIDE.md)
