...
class LinearDimension(Dimension):
    ...
    def get_arrow_points(self) -> List[PrecisionPoint]:
        ...
        arrow_point1 = PrecisionPoint(
            ...
            - arrow_length
            * math.cos(float(direction.angle_to(PrecisionVector(1, 0)) + arrow_angle)),
            end.y
            - arrow_length
            * math.sin(float(direction.angle_to(PrecisionVector(1, 0)) + arrow_angle)),
        )
...
class AutoDimensioner:
    ...
    def auto_dimension_rectangle(
        self, points: List[PrecisionPoint], style_name: str = "standard"
    ):
...
class DimensioningSystem:
    ...
    def create_linear_dimension(
        ...
        """Create a linear dimension."""
        return self.dimension_manager.create_linear_dimension(
            start_point, end_point, style_name
        )
    ...
    def create_radial_dimension(
        ...
        """Create a radial dimension."""
        return self.dimension_manager.create_radial_dimension(
            center_point, radius, angle, style_name
        )
    ...
    def create_angular_dimension(
        ...
        """Create an angular dimension."""
        return self.dimension_manager.create_angular_dimension(
            center_point, start_point, end_point, style_name
        )
    ...
    def create_aligned_dimension(
        ...
        """Create an aligned dimension."""
        return self.dimension_manager.create_aligned_dimension(
            start_point, end_point, style_name
        )
    ...
    def create_ordinate_dimension(
        ...
        """Create an ordinate dimension."""
        return self.dimension_manager.create_ordinate_dimension(
            origin_point, measured_point, is_x_coordinate, style_name
        )
    ...
    def auto_dimension_circle(
        ...
        """Automatically dimension a circle."""
        return self.auto_dimensioner.auto_dimension_circle(
            center_point, radius, style_name
        )
...
def create_dimension_style(
    name: str,
    text_height: Union[float, decimal.Decimal] = 2.5,
    precision: int = 2,
    units: str = "mm",
) -> DimensionStyle:
