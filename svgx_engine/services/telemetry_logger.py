...
class TelemetryLogger:
    ...
    def log_event(self, event_type: TelemetryEventType, operation_name: str, 
    ...
    def log_performance(self, operation_name: str, duration_ms: float, metadata: Optional[Dict[str, Any]] = None):
        """Log a performance event."""
        self.log_event(TelemetryEventType.PERFORMANCE, operation_name, duration_ms, metadata)
    
    def log_operation(self, operation_name: str, metadata: Optional[Dict[str, Any]] = None):
        """Log an operation event."""
        self.log_event(TelemetryEventType.OPERATION, operation_name, metadata=metadata)
    
    def log_error(self, operation_name: str, error_message: str, metadata: Optional[Dict[str, Any]] = None):
        """Log an error event."""
        self.log_event(TelemetryEventType.ERROR, operation_name, error_message=error_message, metadata=metadata)
    
    def log_warning(self, operation_name: str, warning_message: str, metadata: Optional[Dict[str, Any]] = None):
        """Log a warning event."""
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_duration_ms": total_duration / total_events if total_events > 0 else 0,
