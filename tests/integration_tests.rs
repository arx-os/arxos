...
mod tests {
    ...
    fn test_room_creation() {
        let room = Room::new("Test Room".to_string(), RoomType::Classroom);
    ...
    fn test_room_with_equipment() {
        let mut room = Room::new("Test Room".to_string(), RoomType::Office);
    ...
    fn test_spatial_properties_update() {
        use arxos::core::{BoundingBox, Dimensions, Position, SpatialProperties};

        let mut room = Room::new("Spatial Room".to_string(), RoomType::Classroom);
    ...
    fn test_building_structure() {
        ...
        let mut building = Building::new("Test Building".to_string(), "/test/building".to_string());
    ...
    fn test_floor_find() {
        ...
        let mut building = Building::new("Multi Floor Building".to_string(), "/test".to_string());
    ...
    fn test_extract_equipment_from_ar_scan() {
        ...
        assert_eq!(
            vav.properties.get("detection_method"),
            Some(&"ARKit".to_string())
        );
    ...
    fn test_sensor_data_to_equipment_status_flow() {
        use arxos::hardware::{SensorIngestionConfig, SensorIngestionService};
        use std::fs;
        use std::path::PathBuf;
    ...
    fn test_ar_scan_to_pending_to_equipment_flow() {
        ...
        use arxos::ar_integration::{DetectedEquipmentInfo, PendingEquipmentManager};
    ...
    fn test_ar_scan_data_validation() {
        use arxos::ar_integration::processing::{
            validate_ar_scan_data, ARScanData, DetectedEquipmentData,
        };
