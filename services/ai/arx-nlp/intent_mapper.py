...
class IntentMapper:
    ...
    def _load_intent_patterns(self):
        ...
        self.intent_patterns = [
            # Create patterns
            IntentPattern(
                r"create\s+(\w+)", IntentType.CREATE, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"add\s+(\w+)", IntentType.CREATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"new\s+(\w+)", IntentType.CREATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"build\s+(\w+)", IntentType.CREATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"generate\s+(\w+)", IntentType.CREATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Modify patterns
            IntentPattern(
                r"modify\s+(\w+)", IntentType.MODIFY, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"change\s+(\w+)", IntentType.MODIFY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"update\s+(\w+)", IntentType.MODIFY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"edit\s+(\w+)", IntentType.MODIFY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"adjust\s+(\w+)", IntentType.MODIFY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Delete patterns
            IntentPattern(
                r"delete\s+(\w+)", IntentType.DELETE, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"remove\s+(\w+)", IntentType.DELETE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"destroy\s+(\w+)", IntentType.DELETE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"eliminate\s+(\w+)", IntentType.DELETE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Move patterns
            IntentPattern(
                r"move\s+(\w+)", IntentType.MOVE, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"relocate\s+(\w+)", IntentType.MOVE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"transfer\s+(\w+)", IntentType.MOVE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"reposition\s+(\w+)", IntentType.MOVE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Query patterns
            IntentPattern(
                r"find\s+(\w+)", IntentType.QUERY, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"search\s+for\s+(\w+)", IntentType.QUERY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"locate\s+(\w+)", IntentType.QUERY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"where\s+is\s+(\w+)", IntentType.QUERY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"what\s+(\w+)", IntentType.QUERY, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Export patterns
            IntentPattern(
                r"export\s+(\w+)", IntentType.EXPORT, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"save\s+(\w+)", IntentType.EXPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"download\s+(\w+)", IntentType.EXPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"backup\s+(\w+)", IntentType.EXPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Import patterns
            IntentPattern(
                r"import\s+(\w+)", IntentType.IMPORT, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"load\s+(\w+)", IntentType.IMPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"upload\s+(\w+)", IntentType.IMPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"bring\s+in\s+(\w+)", IntentType.IMPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Validate patterns
            IntentPattern(
                r"validate\s+(\w+)", IntentType.VALIDATE, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"check\s+(\w+)", IntentType.VALIDATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"verify\s+(\w+)", IntentType.VALIDATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"test\s+(\w+)", IntentType.VALIDATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Sync patterns
            IntentPattern(
                r"sync\s+(\w+)", IntentType.SYNC, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"synchronize\s+(\w+)", IntentType.SYNC, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"push\s+(\w+)", IntentType.SYNC, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Annotate patterns
            IntentPattern(
                r"annotate\s+(\w+)", IntentType.ANNOTATE, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"note\s+(\w+)", IntentType.ANNOTATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"comment\s+on\s+(\w+)",
                IntentType.ANNOTATE,
                0.05,
                [SlotType.OBJECT_TYPE],
            ),
            IntentPattern(
                r"mark\s+(\w+)", IntentType.ANNOTATE, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Inspect patterns
            IntentPattern(
                r"inspect\s+(\w+)", IntentType.INSPECT, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"examine\s+(\w+)", IntentType.INSPECT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"review\s+(\w+)", IntentType.INSPECT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"look\s+at\s+(\w+)", IntentType.INSPECT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            # Report patterns
            IntentPattern(
                r"report\s+(\w+)", IntentType.REPORT, 0.1, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
            ...
            IntentPattern(
                r"summary\s+(\w+)", IntentType.REPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
            IntentPattern(
                r"status\s+(\w+)", IntentType.REPORT, 0.05, [SlotType.OBJECT_TYPE]
            ),
        ]
    ...
    def _load_slot_patterns(self):
        ...
        self.slot_patterns = [
            ...
            SlotPattern(
                r"\b(room|bedroom|bathroom|kitchen|living|office)\b",
                SlotType.OBJECT_TYPE,
                "room",
            ),
            SlotPattern(
                r"\b(wall|door|window|fixture|equipment|system)\b",
                SlotType.OBJECT_TYPE,
                "building_element",
            ),
            SlotPattern(
                r"\b(floor|building|site)\b", SlotType.OBJECT_TYPE, "structure"
            ),
            # Location patterns
    ...
    def extract_slots(self, text: str, intent_type: IntentType) -> SlotResult:
        ...
        return SlotResult(
            slots=resolved_slots, confidence=min(1.0, len(slots) * 0.1 + 0.5)
        )
    ...
    def _extract_intent_specific_slots(
        ...
        if intent_type == IntentType.CREATE:
            ...
            color_match = re.search(
                r"(red|green|blue|yellow|black|white|gray|grey)", text
            )
            if color_match:
                slots.append(
                    Slot(
    ...
    def get_intent_help(self, intent_type: IntentType) -> str:
        ...
        return help_texts.get(
            intent_type, f"No help available for intent: {intent_type}"
        )
