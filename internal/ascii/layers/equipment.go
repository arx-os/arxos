...
func (e *EquipmentLayer) Render(viewport abim.Viewport) [][]rune {
...
func (e *EquipmentLayer) renderEquipment(buffer [][]rune, eq models.Equipment, vp abim.Viewport) {
...
func (e *EquipmentLayer) SetDirty(regions []abim.Region) {
	e.dirty = regions
}
...
func (e *EquipmentLayer) UpdateEquipment(equipment []models.Equipment) {
	...
	e.dirty = []abim.Region{{0, 0, 1000, 1000}} // Force full redraw
}
...
func (e *EquipmentLayer) FindEquipmentAt(x, y int, vp abim.Viewport) *models.Equipment {
...
func (e *EquipmentLayer) HighlightEquipment(equipmentID string, highlight bool) {
	for i := range e.equipment {
		if e.equipment[i].ID == equipmentID {
			...
			e.dirty = append(e.dirty, abim.Region{x-1, y-1, 3, 3})
			break
		}
	}
}