...
class TestTelemetryAPI:
    ...
    def test_query_data_with_aggregation(self, telemetry_api):
        ...
        # Submit test data
        test_data = [
            {"device_id": "agg_sensor", "timestamp": "2024-01-15T10:00:00Z", "data": {"temperature": 20.0}},
            {"device_id": "agg_sensor", "timestamp": "2024-01-15T10:05:00Z", "data": {"temperature": 22.0}},
    ...
    def test_export_data_csv(self, telemetry_api, tmp_path):
        ...
        # Submit test data
        test_data = [
            {"device_id": "export_sensor", "timestamp": "2024-01-15T10:00:00Z", "data": {"temperature": 22.0}},
