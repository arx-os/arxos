...
from svgx_engine.services.cad.assembly_management import (
    ComponentType,
...
class TestCADSystemComprehensive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        snap_config = SnapConfig(
            enabled=True, tolerance=Decimal("2.0"), visual_feedback=True
        )
    ...
    def test_grid_snap_operations(self):
        ...
        # Create a point
        target_point = PrecisionPoint(
            15.5, 25.5, precision_level=PrecisionLevel.COMPUTE
        )

        # Test snapping
        snapped_point = self.cad_system.snap_point(
            target_point, use_grid=True, use_snap=True
        )
    ...
    def test_end_to_end_workflow(self):
        ...
        self.cad_system.add_component_to_assembly(
            assembly_id, "comp1", "Component 1", "part", snapped_point1
        )
        self.cad_system.add_component_to_assembly(
            assembly_id, "comp2", "Component 2", "part", snapped_point2
        )
