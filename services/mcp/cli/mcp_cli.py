...
class MCPCLI:
    ...
    def validate_building(self, building_file: str, mcp_files: List[str] = None, 
                         output_format: str = "json", output_file: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            # Run validation
            compliance_report = self.engine.validate_building_model(building_model, mcp_files or [])
    ...
    def validate_realtime(self, building_file: str, changed_objects: List[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if changed_objects:
                for obj_id in changed_objects:
                    obj = next((obj for obj in building_model.objects if obj.object_id == obj_id), None)
                    if obj:
    ...
    def generate_report(self, building_file: str, mcp_files: List[str] = None, 
                       report_format: str = "html", output_file: str = None) -> None:
...
def main():
    ...
    validate_parser.add_argument("--output-format", choices=["json", "text"], default="json", help="Output format")
    validate_parser.add_argument("--output-file", help="Output file")
    
    # Real-time validation command
    realtime_parser = subparsers.add_parser("realtime", help="Real-time validation for CAD")
    realtime_parser.add_argument("building_file", help="Building model JSON file")
    realtime_parser.add_argument("--changed-objects", nargs="+", help="Changed object IDs")
    ...
    report_parser.add_argument("--format", choices=["html", "text", "pdf"], default="html", help="Report format")
