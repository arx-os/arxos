...
class TestCadCollaboration(unittest.TestCase):
    ...
    def test_collaboration_file_structure(self):
        ...
        collaboration_path = (
            project_root / "frontend/web/static/js/cad-collaboration.js"
        )
    ...
    def test_collaboration_integration(self):
        ...
        self.assertIn(
            "this.collaboration = new CadCollaboration(this, this.apiClient)", content
        )
    ...
    def test_message_handling(self):
        ...
        for message_type in message_types:
            self.assertIn(
                message_type, content, f"Missing message type: {message_type}"
            )
