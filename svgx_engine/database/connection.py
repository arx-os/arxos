...
class DatabaseConnectionManager:
    ...
    def _get_connect_args(self) -> Dict[str, Any]:
        ...
        if "postgresql" in database_url:
            return {"connect_timeout": 10, "application_name": "svgx_engine"}
    ...
    def _test_connection(self) -> bool:
        ...
        try:
            ...
            self._connection_health.update(
                {"last_check": datetime.now(), "is_healthy": True, "error_count": 0}
            )
            return True
        except Exception as e:
    ...
    def get_connection_health(self) -> Dict[str, Any]:
        ...
        if not self._connection_health[
            "last_check"
        ] or datetime.now() - self._connection_health["last_check"] > timedelta(
            minutes=5
        ):
            self._test_connection()
