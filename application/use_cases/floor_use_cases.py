        ...
        try:
            ...
            if not request.floor_number or request.floor_number < 0:
                return CreateFloorResponse(
                    success=False, error_message="Valid floor number is required"
                )
            ...
            return CreateFloorResponse(
                success=False, error_message=f"Floor already exists: {str(e)}"
            )
        except InvalidFloorError as e:
            return CreateFloorResponse(
                success=False, error_message=f"Invalid floor data: {str(e)}"
            )
        ...
        try:
            ...
            if not floor:
                return UpdateFloorResponse(
                    success=False, error_message="Floor not found"
                )
            ...
            return UpdateFloorResponse(success=False, error_message="Floor not found")
...
class GetFloorUseCase:
    ...
    def execute(self, floor_id: str) -> GetFloorResponse:
        ...
        try:
            ...
            if not floor:
                return GetFloorResponse(success=False, error_message="Floor not found")
            ...
            return GetFloorResponse(success=True, floor=floor_data)
...
class DeleteFloorUseCase:
    ...
    def execute(self, floor_id: str) -> DeleteFloorResponse:
        ...
        try:
            ...
            return DeleteFloorResponse(success=False, error_message="Floor not found")
        except Exception as e:
            return DeleteFloorResponse(
