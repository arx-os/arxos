    ...
    return BuildingModel(
        ...
        objects=[
            ...
            BuildingObject(
                ...
                location={"x": 600, "y": 200, "z": 0, "width": 20, "height": 20, "depth": 100}
            ),
            ...
            BuildingObject(
                ...
                location={"x": 400, "y": 150, "z": 0, "width": 30, "height": 50, "depth": 25}
            ),
            BuildingObject(
                object_id="toilet_1",
                ...
                location={"x": 100, "y": 200, "z": 0, "width": 20, "height": 30, "depth": 20}
            ),
            ...
            BuildingObject(
                ...
                location={"x": 0, "y": 0, "z": 0, "width": 1000, "height": 1000, "depth": 12}
            ),
            BuildingObject(
                ...
                location={"x": 100, "y": 100, "z": 0, "width": 12, "height": 12, "depth": 120}
            ),
            ...
            BuildingObject(
                ...
                location={"x": 140, "y": 240, "z": 0, "width": 200, "height": 100, "depth": 8}
            ),
            BuildingObject(
                ...
                location={"x": 200, "y": 300, "z": 0, "width": 250, "height": 200, "depth": 12}
            ),
            ...
            BuildingObject(
                ...
                location={"x": 0, "y": 0, "z": 120, "width": 1000, "height": 1000, "depth": 6}
            ),
            BuildingObject(
                ...
                location={"x": 200, "y": 100, "z": 48, "width": 4, "height": 3, "depth": 1}
            )
        ]
    )
...
def demonstrate_cross_system_validation():
    ...
    try:
        ...
        for report in compliance_report.validation_reports:
            for result in report.results:
                for violation in result.violations:
                    if "cross" in violation.message.lower() or "interaction" in violation.message.lower():
                        print(f"   • {violation.message}")
                        interaction_count += 1
...
def main():
    ...
    try:
        ...
        print()
        print("🏆 The MCP system is now fully functional with comprehensive building code validation!")
