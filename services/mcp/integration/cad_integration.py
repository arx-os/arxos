...
class CADIntegration:
    ...
    def start_realtime_validation(self, building_model: BuildingModel, 
            ...
            for result in report.results:
                for violation in result.violations:
                    ...
                    highlight = CADHighlight(
                        ...
                        highlight_type=self._get_highlight_type(violation.severity.value),
                        color=self.highlight_colors.get(violation.severity.value, '#000000'),
    ...
    def _highlight_changed(self, old: CADHighlight, new: CADHighlight) -> bool:
        ...
        return (old.highlight_type != new.highlight_type or
    ...
    def _notify_highlight_changes(self, changed_highlights: Dict[str, CADHighlight], 
    ...
    def validate_object_realtime(self, obj: BuildingObject, 
                               building_model: BuildingModel) -> List[CADHighlight]:
...
class CADWebSocket:
    ...
    def __init__(self, cad_integration: CADIntegration):
        ...
        # Register callbacks
        self.cad_integration.register_callback('validation_update', self._broadcast_update)
        self.cad_integration.register_callback('highlight_changes', self._broadcast_changes)
    ...
    def _broadcast_changes(self, changed_highlights: Dict[str, CADHighlight], 
                          removed_objects: List[str]):
