...
class TestSignalPropagationService(unittest.TestCase):
    ...
    def test_calculate_received_power(self):
        ...
        self.assertLess(
            received_power, 10 * np.log10(source.power * 1000) + source.antenna.gain
        )
    ...
    def test_calculate_signal_strength(self):
        ...
        signal_strength = self.service._calculate_signal_strength(
            received_power, environment
        )
    ...
    def test_analyze_multipath(self):
        ...
        direct_component = next(
            (comp for comp in multipath_components if comp["type"] == "direct"), None
        )
...
class TestAntennaAnalyzer(unittest.TestCase):
    ...
    def test_calculate_antenna_pattern(self):
        ...
        self.assertEqual(
            pattern.gain_pattern.shape,
            (len(pattern.theta_angles), len(pattern.phi_angles)),
        )
    ...
    def test_dipole_pattern_calculation(self):
        ...
        gain_pattern, phase_pattern, polarization_pattern = (
            self.analyzer._calculate_dipole_pattern(theta_angles, phi_angles, frequency)
        )
...
class TestInterferenceCalculator(unittest.TestCase):
    ...
    def test_calculate_co_channel_interference(self):
        ...
        self.assertLess(
            interference,
            10 * np.log10(interference_source.power * 1000)
            + interference_source.antenna_gain,
        )
    ...
    def test_calculate_adjacent_channel_interference(self):
        ...
        co_channel = self.calculator._calculate_co_channel_interference(
            desired_signal, interference_source, distance
        )
    ...
    def test_calculate_signal_to_interference_ratio(self):
        ...
        sir = self.calculator._calculate_signal_to_interference_ratio(
            self.request, interference_level
        )
    ...
    def test_determine_severity_level(self):
        ...
        severity = self.calculator._determine_severity_level(
            sir, cir, interference_level
        )
    ...
    def test_predict_interference(self):
        ...
        self.assertEqual(
            len(prediction["time_points"]), len(prediction["interference_levels"])
        )
        self.assertEqual(
            len(prediction["time_points"]), len(prediction["confidence_intervals"])
        )
...
class TestSignalPropagationIntegration(unittest.TestCase):
    ...
    def test_end_to_end_signal_analysis(self):
        ...
        self.assertLess(
            signal_result.received_power,
            10 * np.log10(signal_source.power * 1000) + signal_source.antenna.gain,
        )
        ...
        interference_result = self.interference_calculator.analyze_interference(
    ...
    def test_error_handling(self):
        ...
        invalid_signal_source = SignalSource(
            ...
            antenna=AntennaProperties(
                "test", "dipole", 2.4e9, 2.15, 0.95, "vertical", 78.0, 78.0, 0.0
            ),
            position=(0.0, 0.0, 10.0),
            height=10.0,
        )
