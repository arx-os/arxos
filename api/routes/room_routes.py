...
from application.dto import CreateRoomRequest, UpdateRoomRequest, GetRoomRequest
...
class RoomCreateRequest(BaseModel):
    ...
    room_number: str = Field(
        ..., description="Room number", min_length=1, max_length=50
    )
    name: str = Field(..., description="Room name", min_length=1, max_length=255)
    room_type: str = Field(
        ..., description="Type of room", min_length=1, max_length=100
    )
    ...
    description: Optional[str] = Field(
        None, description="Room description", max_length=1000
    )
...
class RoomUpdateRequest(BaseModel):
    ...
    room_number: Optional[str] = Field(
        None, description="Room number", min_length=1, max_length=50
    )
    name: Optional[str] = Field(
        None, description="Room name", min_length=1, max_length=255
    )
    room_type: Optional[str] = Field(
        None, description="Type of room", min_length=1, max_length=100
    )
    area: Optional[float] = Field(None, ge=0, description="Room area in square meters")
    capacity: Optional[int] = Field(None, ge=0, description="Room capacity")
    description: Optional[str] = Field(
...
async def delete_room(
    ...
    try:
        ...
        result = room_service.delete_room(room_id=room_id, deleted_by=user.user_id)
