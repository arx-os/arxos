...
from ..models.nlp_models import Intent, SlotResult, NLPContext
...
class ContextManager:
    ...
    def _load_default_context(self):
        ...
        default_objects = {
            "bedroom": ObjectReference("room_001", "room", "floor_1", {"type": "bedroom"}),
            "bathroom": ObjectReference("room_002", "room", "floor_1", {"type": "bathroom"}),
            "kitchen": ObjectReference("room_003", "room", "floor_1", {"type": "kitchen"}),
            "living": ObjectReference("room_004", "room", "floor_1", {"type": "living"}),
            "office": ObjectReference("room_005", "room", "floor_1", {"type": "office"}),
            "wall": ObjectReference("wall_001", "wall", "floor_1", {"type": "interior"}),
            "door": ObjectReference("door_001", "door", "floor_1", {"type": "interior"}),
            "window": ObjectReference("window_001", "window", "floor_1", {"type": "standard"}),
            "fixture": ObjectReference("fixture_001", "fixture", "floor_1", {"type": "generic"}),
            "equipment": ObjectReference("equipment_001", "equipment", "floor_1", {"type": "generic"}),
            "system": ObjectReference("system_001", "system", "building", {"type": "generic"})
        }
        
        for name, obj_ref in default_objects.items():
            self.object_references[name] = obj_ref
    
    def resolve_context(self, intent: Intent, slot_result: SlotResult, context: NLPContext) -> NLPContext:
        """
...
def resolve_context(intent: Intent, slot_result: SlotResult, context: NLPContext, config: Optional[Dict[str, Any]] = None) -> NLPContext:
    """
    Convenience function for quick context resolution
