...
from svgx_engine.api.cad_api import (
    ...
    AddPointRequest, AddPointResponse,
    AddConstraintRequest, AddConstraintResponse,
    AddDimensionRequest, AddDimensionResponse,
    AddParameterRequest, AddParameterResponse,
    CreateAssemblyRequest, CreateAssemblyResponse,
    AddComponentRequest, AddComponentResponse,
    GenerateViewsRequest, GenerateViewsResponse,
    ExportDrawingRequest, ExportDrawingResponse,
    DrawingInfoResponse, CADSystemInfoResponse
)
...
class CreateDrawingSessionRequest(BaseModel):
    ...
    collaboration_enabled: bool = Field(True, description="Enable real-time collaboration")
...
@router.post("/session/{session_id}/export", response_model=ExportDrawingSessionResponse)
