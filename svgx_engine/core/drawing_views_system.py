...
class DrawingView:
    ...
    def _project_to_xz(self, geometry: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if (
            "center" in geometry
            and "y" in geometry["center"]
            and "z" in geometry["center"]
        ):
            geometry["center"]["y"], geometry["center"]["z"] = (
                geometry["center"]["z"],
                geometry["center"]["y"],
            )
    ...
    def _project_to_yz(self, geometry: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if (
            "center" in geometry
            and "x" in geometry["center"]
            and "z" in geometry["center"]
        ):
            geometry["center"]["x"], geometry["center"]["z"] = (
                geometry["center"]["z"],
                geometry["center"]["x"],
            )
...
class ViewGenerator:
    ...
    def create_view(
        self, name: str, view_type: ViewType, config: ViewConfig
    ) -> DrawingView:
        ...
        view = DrawingView(
            view_id=view_id, name=name, view_type=view_type, config=config
        )
    ...
    def generate_standard_views(
        self, model_geometry: Dict[str, Any]
    ...
    def generate_section_view(
        self, model_geometry: Dict[str, Any], section_plane: Dict[str, Any]
    ) -> DrawingView:
        ...
        section_view = self.create_view(
            "Section View", ViewType.SECTION, section_config
        )
...
class ViewManager:
    ...
    def get_layout_views(self, layout_id: str) -> List[DrawingView]:
        ...
        if layout_id in self.view_layouts:
            ...
            return [
                view for view in self.view_generator.views if view.view_id in view_ids
            ]
        return []
