...
class ProjectCreateRequest(BaseModel):
    ...
    description: Optional[str] = Field(
        None, description="Project description", max_length=1000
    )
...
class ProjectUpdateRequest(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description="Project name", min_length=1, max_length=255
    )
    description: Optional[str] = Field(
        None, description="Project description", max_length=1000
    )
        ...
        if result.success:
            return format_success_response(
                data={
                    ...
                    "building_id": (
                        str(result.building_id) if result.building_id else None
                    ),
        ...
        if result.success and result.project:
            ...
            return format_success_response(
                data={
                    ...
                    "description": project.description,
                    "building_id": (
                        str(project.building_id) if project.building_id else None
                    ),
                    "status": project.status,
                    "created_by": project.created_by,
                    "created_at": (
...
async def delete_project(
    ...
    try:
        ...
        result = project_service.delete_project(
            project_id=project_id, deleted_by=user.user_id
        )
