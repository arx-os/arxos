...
class ComputerVisionEngine:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.enable_gpu = self.config.get('cv_enable_gpu', False)  # Disabled for lightweight version
...
class NLPEngine:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.supported_languages = self.config.get('supported_languages', ['en', 'de', 'fr'])
    ...
    def interpret_building_code(self, text_content: str, language: str = 'en') -> NLPResult:
        ...
        try:
            ...
            compliance_analysis = self._analyze_compliance(text_content, extracted_rules)
    ...
    def analyze_compliance_text(self, text_content: str) -> Dict[str, Any]:
        ...
        try:
            ...
            analysis['compliance_score'] = self._calculate_text_compliance_score(compliance_indicators)
    ...
    def _extract_rules_from_text(self, text: str, language: str) -> List[Dict[str, Any]]:
    ...
    def _analyze_compliance(self, text: str, rules: List[Dict[str, Any]]) -> Dict[str, Any]:
...
class MLRuleEngine:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.feature_scaling = self.config.get('feature_scaling', False)  # Disabled for lightweight
    ...
    def interpret_building_code_nlp(self, text_content: str, language: str = 'en') -> NLPResult:
    ...
    def extract_features(self, building_model: BuildingModel, rule_id: str) -> Dict[str, Any]:
        """
        ...
        for feature_def in self.feature_definitions[rule_id]:
            try:
                if feature_def.source == 'property':
                    ...
                    value = self._extract_calculated_feature(building_model, feature_def)
                else:
    ...
    def _extract_property_feature(self, building_model: BuildingModel, feature_def: MLFeature) -> Any:
    ...
    def _extract_location_feature(self, building_model: BuildingModel, feature_def: MLFeature) -> Any:
    ...
    def _extract_calculated_feature(self, building_model: BuildingModel, feature_def: MLFeature) -> Any:
    ...
    def predict_compliance(self, building_model: BuildingModel, rule_id: str) -> MLPrediction:
        """
    ...
    def create_ml_rule(self, rule_id: str, name: str, description: str,
                       features: List[MLFeature], actions: List[RuleAction],
                       model_type: str = 'classifier') -> MCPRule:
        """
    ...
    def validate_building_model_ml(self, building_model: BuildingModel,
                                 mcp_files: List[str]) -> Dict[str, Any]:
        """
    ...
    def _execute_ml_rule(self, rule: MCPRule, building_model: BuildingModel, 
                         prediction: MLPrediction) -> Dict[str, Any]:
