...
Honesty: confidence floats are **not** probability ([lidar-confidence.md](../reference/lidar-confidence.md)).  
...
| G4 | Capture node not Pi-class for large clouds | [resource-limits.md](../reference/resource-limits.md) |
...
Fill [field-truth-log.md](../pilot/field-truth-log.md) **§B S6 template**:
...
**Related:** [field-truth-log.md](../pilot/field-truth-log.md) · [l1-supported-workflow.md](../pilot/supported-workflow.md) · [resource-limits.md](../reference/resource-limits.md) · [lidar-confidence.md](../reference/lidar-confidence.md)
