...
struct EquipmentMeshResult {
    mesh_index: usize,
    _accessor_start: usize,
    _buffer_view_start: usize,
    buffer_data: Vec<u8>,
}
...
impl GLTFExporter {
    ...
    fn build_gltf_root(&self) -> Result<Root, Box<dyn std::error::Error>> {
        ...
        for floor in &self.building_data.floors {
            ...
            for equipment in &floor.equipment {
                ...
                let mesh_result = self.create_equipment_mesh(
                    equipment,
                    &material_map,
                    buffer_offset,
                    &mut meshes,
                ...
                buffer_data.extend_from_slice(&mesh_result.buffer_data);
                ...
                let equipment_node = Node {
                    ...
                    matrix: None,
                    mesh: Some(Index::new(mesh_result.mesh_index as u32)),
                    rotation: None,
                    scale: None,
                    skin: None,
                    translation: Some([
    ...
    fn create_equipment_mesh(
    ...
    ) -> Result<EquipmentMeshResult, Box<dyn std::error::Error>> {
        ...
        Ok(EquipmentMeshResult {
            mesh_index: mesh_id,
            _accessor_start: position_accessor_id,
            _buffer_view_start: vertex_buffer_view_id,
            buffer_data,
        })
    }
