...
class FloorCreateRequest(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Floor description", max_length=1000)
    total_area: Optional[float] = Field(None, ge=0, description="Total floor area in square meters")
...
class FloorUpdateRequest(BaseModel):
    ...
    name: Optional[str] = Field(None, description="Floor name", min_length=1, max_length=255)
    description: Optional[str] = Field(None, description="Floor description", max_length=1000)
    total_area: Optional[float] = Field(None, ge=0, description="Total floor area in square meters")
...
async def delete_floor(
    ...
    try:
        ...
        result = floor_service.delete_floor(
            floor_id=floor_id,
