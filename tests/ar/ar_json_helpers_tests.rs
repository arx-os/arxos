...
mod tests {
    ...
    fn test_parse_detection_method_arkit() {
        ...
        assert!(matches!(method, arxos::ar_integration::DetectionMethod::ARKit));
    }
    ...
    fn test_parse_detection_method_arcore() {
        ...
        let method = json_helpers::parse_detection_method(&json);
        assert!(matches!(method, arxos::ar_integration::DetectionMethod::ARCore));
    }
    ...
    fn test_parse_detection_method_lidar() {
        ...
        let method = json_helpers::parse_detection_method(&json);
        assert!(matches!(method, arxos::ar_integration::DetectionMethod::LiDAR));
    }
    ...
    fn test_parse_detection_method_default() {
        ...
        let method = json_helpers::parse_detection_method(&json);
        assert!(matches!(method, arxos::ar_integration::DetectionMethod::Manual));
    }
    ...
    fn test_parse_bounding_box() {
        let position = Point3D { x: 10.0, y: 20.0, z: 5.0 };
