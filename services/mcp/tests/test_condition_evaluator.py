...
from models.mcp_models import (
    BuildingObject, RuleCondition, ConditionType, RuleSeverity, RuleCategory
)
...
class TestConditionEvaluator:
    ...
    def test_relationship_condition(self):
        ...
        self.test_objects[0].connections = ["room_001"]  # outlet_001 connected to room_001
