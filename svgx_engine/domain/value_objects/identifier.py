...
class Identifier:
    ...
    def _validate_value(self):
        ...
        if not re.match(r'^[a-zA-Z0-9_-]+$', self.value):
            raise ValueError("Identifier can only contain alphanumeric characters, hyphens, and underscores")
...
def generate_uuid(cls, prefix: Optional[str] = None) -> 'Identifier':
    ...
    @classmethod
def generate_sequential(cls, sequence: int, prefix: Optional[str] = None,
                          padding: int = 6) -> 'Identifier':
        """
