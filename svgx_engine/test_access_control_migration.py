...
from svgx_engine.services.access_control import (
    AccessControlService, UserRole, ResourceType, ActionType, PermissionLevel
)
from svgx_engine.utils.errors import AccessControlError, ValidationError
...
def test_access_control_migration():
    ...
    try:
        ...
        ac_service = AccessControlService(db_path=db_path)
