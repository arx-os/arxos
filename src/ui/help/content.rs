...
fn general_help() -> Vec<Line<'static>> {
    vec![
        ...
        Line::from(Span::raw("")),
        Line::from(vec![Span::styled(
            "For context-specific help, press ? in any screen",
            Style::default(),
        )]),
    ]
}
...
mod tests {
    ...
    fn test_get_context_help_all_contexts() {
        ...
        for context in contexts {
            ...
            assert!(
                !help.is_empty(),
                "Help content should not be empty for {:?}",
                context
            );
            // First line should be a styled title
            assert!(
                !help[0].spans.is_empty(),
                "Help should have at least one line for {:?}",
                context
            );
        }
    }
    ...
    fn test_equipment_browser_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("Equipment Browser"),
            "Should contain Equipment Browser title"
        );
        assert!(
    ...
    fn test_room_explorer_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("Room Explorer"),
            "Should contain Room Explorer title"
        );
    }
    ...
    fn test_status_dashboard_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("Status Dashboard"),
            "Should contain Status Dashboard title"
        );
    }
    ...
    fn test_search_browser_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("Search Browser"),
            "Should contain Search Browser title"
        );
    }
    ...
    fn test_watch_dashboard_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("Watch Dashboard"),
            "Should contain Watch Dashboard title"
        );
    }
    ...
    fn test_config_wizard_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("Configuration Wizard"),
            "Should contain Configuration Wizard title"
        );
    }
    ...
    fn test_ar_pending_manager_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("AR Pending Manager"),
            "Should contain AR Pending Manager title"
        );
    }
    ...
    fn test_diff_viewer_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("Diff Viewer"),
            "Should contain Diff Viewer title"
        );
    }
    ...
    fn test_health_dashboard_help() {
        ...
        assert!(
            ...
            "Should contain Health Dashboard title"
        );
    }
    ...
    fn test_command_palette_help() {
        ...
        assert!(
            ...
            "Should contain Command Palette title"
        );
    }
    ...
    fn test_interactive_3d_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("3D Renderer"),
            "Should contain 3D Renderer title"
        );
    }
    ...
    fn test_general_help() {
        ...
        let text: String = help
            ...
            .collect();
        assert!(
            text.contains("ArxOS General Help"),
            "Should contain ArxOS General Help title"
        );
        assert!(
            text.contains("Universal Shortcuts"),
            "Should contain Universal Shortcuts section"
        );
    }
