...
class DatabaseManager:
    ...
    def update_document(
        self, document_id: int, content: str, metadata: Optional[Dict[str, Any]] = None
    ) -> QueryResult:
        """Update a document."""
        query = """
    ...
    def set_session_data(
        self, session_id: str, data: Dict[str, Any], user_id: Optional[str] = None
    ) -> QueryResult:
        """Set session data."""
        query = """
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {"pool_stats": pool_stats, "table_stats": table_stats}
...
def update_document(
    document_id: int, content: str, metadata: Optional[Dict[str, Any]] = None
) -> QueryResult:
    """Update a document."""
    manager = get_database_manager()
...
def set_session_data(
    session_id: str, data: Dict[str, Any], user_id: Optional[str] = None
) -> QueryResult:
    """Set session data."""
    manager = get_database_manager()
