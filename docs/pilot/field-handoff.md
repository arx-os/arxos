...
**Living roadmap (phases HB0–HB7):** [horizon-b-roadmap.md](../process/horizon-b-roadmap.md)  
**Starter pack (zip checklist):** [pilot-starter-pack.md](starter-pack.md) · **Weekly status:** [sprint-status-dashboard.md](../process/sprint-status-dashboard.md)

---

## B0 — Safety (R10)

1. Read and fill **[pilot-charter.md](charter.md)** (parties, site, pin blank, initials on §3).  
...
1. Use the **preferred pin** in [pilot-release.md](release.md): **`v2.0.0-pilot.5`** @ `ad5213dca08cef52cc90d9b80037f0dbaaa14a8d`.  
2. Record **that tag + full SHA** in charter §2 and install from that pin only (`cargo install --path .` = default: compiler + TUI).  
3. Second person (not the doc author) runs **[second-person-checklist.md](second-person-checklist.md)** on a district-like machine using only **[l1-supported-workflow.md](supported-workflow.md)**.  
...
2. Day-1 commands: **[field-day-1-runbook.md](day-1-runbook.md)** (S3 pin + S5 IFC + LossReport).  
...
**Related:** [INDEX.md](../INDEX.md) · [identity.md](../reference/identity.md) · [ifc-limitations.md](../reference/ifc-limitations.md)
