...
class BuildingDomainService:
    ...
    def update_building_status(
        self, building_id: BuildingId, new_status: BuildingStatus, updated_by: str
    ) -> Building:
    ...
    def get_building_statistics(self, building_id: BuildingId) -> Dict[str, Any]:
        ...
        total_devices = sum(
            len(room.devices) for floor in building.floors for room in floor.rooms
        )
        ...
        device_health_rate = (
            (operational_devices / total_devices * 100) if total_devices > 0 else 0
        )
    ...
    def calculate_building_efficiency(
        ...
        room_density = (
            total_rooms / building.floor_count if building.floor_count > 0 else 0
        )
...
class RoomDomainService:
    ...
    def create_room(
        ...
        existing_room = self.room_repository.get_by_floor_and_number(
    ...
    def calculate_room_efficiency(self, room_id: RoomId) -> Dict[str, float]:
        ...
        if area == 0:
            return {"device_density": 0.0, "space_utilization": 0.0}
...
class UserDomainService:
    ...
    def get_user_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "activation_rate": (
                round((active_count / len(all_users)) * 100, 2) if all_users else 0
            ),
        }
...
class ProjectDomainService:
    ...
    def get_project_statistics(self, project_id: ProjectId) -> Dict[str, Any]:
        ...
        if project.start_date and project.end_date:
            ...
            progress_percentage = (
                min((elapsed_days / total_days) * 100, 100) if total_days > 0 else 0
            )
        else:
    ...
    def get_project_summary(self) -> Dict[str, Any]:
        ...
        avg_duration = (
            total_duration / projects_with_duration if projects_with_duration > 0 else 0
        )
