...
fn set_configuration_value(config_manager: &mut ConfigManager, set_value: &str) -> Result<(), Box<dyn std::error::Error>> {
...
fn reset_configuration(config_manager: &mut ConfigManager) -> Result<(), Box<dyn std::error::Error>> {
    config_manager.update_config(|config| {
...
fn edit_configuration(config_manager: &mut ConfigManager) -> Result<(), Box<dyn std::error::Error>> {
