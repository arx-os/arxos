...
class SVGXBehaviorEngine:
    ...
    async def handle_event(
        self, element_id: str, event_type: str, event_data: Dict[str, Any] = None
    ):
        """
    ...
    async def _execute_trigger(
        self, trigger: BehaviorTrigger, element_id: str, event_data: Dict[str, Any]
    ):
        """
    ...
    async def _execute_action(
        self, action: BehaviorAction, element_id: str, event_data: Dict[str, Any]
    ):
        """
        Execute an action.
    ...
    def _handle_condition(self, element_id: str, event_data: Dict[str, Any]):
        ...
        return asyncio.create_task(
            self.handle_event(element_id, "condition", event_data)
        )
    ...
    def _handle_external(self, element_id: str, event_data: Dict[str, Any]):
        ...
        return asyncio.create_task(
            self.handle_event(element_id, "external", event_data)
        )
