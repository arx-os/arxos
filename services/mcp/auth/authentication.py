...
class AuthenticationManager:
    ...
    def __init__(self):
        ...
        self.role_permissions = {
            UserRole.ADMIN: [
                ...
                Permission.READ_BUILDING_MODELS, Permission.WRITE_BUILDING_MODELS,
                Permission.READ_MCP_FILES, Permission.WRITE_MCP_FILES,
            ...
            UserRole.ENGINEER: [
                Permission.READ_VALIDATION, Permission.WRITE_VALIDATION,
                Permission.READ_BUILDING_MODELS, Permission.WRITE_BUILDING_MODELS,
                Permission.READ_MCP_FILES, Permission.READ_REPORTS, Permission.WRITE_REPORTS
            ],
            UserRole.ARCHITECT: [
                Permission.READ_VALIDATION, Permission.WRITE_VALIDATION,
                Permission.READ_BUILDING_MODELS, Permission.WRITE_BUILDING_MODELS,
                Permission.READ_MCP_FILES, Permission.READ_REPORTS
            ],
            UserRole.INSPECTOR: [
                Permission.READ_VALIDATION, Permission.READ_BUILDING_MODELS,
                Permission.READ_MCP_FILES, Permission.READ_REPORTS, Permission.WRITE_REPORTS
            ],
            UserRole.VIEWER: [
                Permission.READ_VALIDATION, Permission.READ_BUILDING_MODELS,
    ...
    def verify_token(self, credentials: HTTPAuthorizationCredentials = Depends(HTTPBearer())) -> TokenData:
...
def get_current_user(current_user: User = Depends(auth_manager.get_current_user)) -> User:
    """Get current authenticated user"""
    return current_user
