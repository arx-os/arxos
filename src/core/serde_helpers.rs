...
#[allow(dead_code)] // Reserved for YAML format migration - used via #[serde(serialize_with = "...")]
...
#[allow(dead_code)] // Reserved for YAML format migration - used via #[serde(deserialize_with = "...")]
