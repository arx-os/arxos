...
class StagingDeployer:
    ...
    def __init__(self, config: Dict):
        ...
        self.validation_script = config.get(
    ...
    def run_validation(self, service_url: str) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                validation_cmd, env=env, capture_output=True, text=True
            )
...
def main():
    ...
    try:
        ...
        if success:
            ...
            print(
                f"Image: {config['registry']}/{config['image_name']}:{config['image_tag']}"
            )
