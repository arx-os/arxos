...
| **Related** | [`adr.md`](./adr.md) Decision 9 · [`../arxos_manifest.md`](../arxos_manifest.md) §1.1a / device path (to be reconciled after purge) · Phase 0 inventory (session 2026-07-24) |
