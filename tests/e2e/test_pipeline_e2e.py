        ...
        schema_data = {
            ...
            "objects": {
                "sensor": {
                    ...
                    "relationships": {
                        "connected_to": ["controller", "power_supply"]
                    },
...
"""
        ...
        behavior_result = self.service.handle_operation("validate-behavior", {
            "system": self.test_system
        })
        ...
        pipeline_result = self.service.handle_operation("execute-pipeline", {
            "system": self.test_system,
            "steps": ["validate-schema", "add-symbols", "implement-behavior", "compliance"]
        })
        ...
        integration_result = self.service.handle_operation("verify-integration", {
            "system": self.test_system
        })
    ...
    def test_pipeline_error_recovery_e2e(self):
        ...
        self.assertFalse(pipeline_result.get("success", True),
                        "Pipeline should fail with invalid schema")
        print("✅ Error detection working")
        
        # Test rollback functionality
        rollback_result = self.service.handle_operation("rollback", {
            "system": error_system
        })
    ...
    def test_pipeline_performance_e2e(self):
        ...
        for system in systems:
            result = self.service.handle_operation("execute-pipeline", {
                "system": system,
        ...
        print(f"✅ Performance test passed: {len(systems)} systems in {execution_time:.2f}s")
    ...
    def test_pipeline_cli_e2e(self):
        ...
        for cmd in cli_commands:
            try:
                ...
                self.assertNotEqual(result.returncode, -1, f"CLI command failed: {' '.join(cmd)}")
    ...
    def test_pipeline_api_e2e(self):
        ...
        for operation, params in api_operations:
            try:
                ...
                self.assertIsNotNone(result, f"API operation {operation} should return a result")
