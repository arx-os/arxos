...
| **Related** | [`agent-client-interface.md`](../reference/agent-client-interface.md) · [`adr-native-capture-interface.md`](native-capture-interface.md) |
...
See Decision 10–11 for capture model and wire contract details. Living summary: [`agent-client-interface.md`](../reference/agent-client-interface.md).
