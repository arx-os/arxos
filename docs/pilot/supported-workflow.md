...
**Install:** Pinned release only — see [pilot-release.md](release.md)
...
**Living plan:** [horizon-b-roadmap.md](../process/horizon-b-roadmap.md) · **Packet:** [field-handoff.md](field-handoff.md)
...
If IFC is incomplete, fix vendor export settings. See [ifc-limitations.md](../reference/ifc-limitations.md).
...
Import size/point ceilings: [resource-limits.md](../reference/resource-limits.md) (raise only with hardware headroom).
...
**Identity:** hierarchical `address` is the operational identity — see [identity.md](../reference/identity.md).
...
Identity after export/import: [identity.md](../reference/identity.md).
...
**Related:** [pilot-charter.md](charter.md) · [second-person-checklist.md](second-person-checklist.md) · [field-truth-log.md](field-truth-log.md) · [data-classification.md](data-classification.md)
