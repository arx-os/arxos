...
impl StatusBadge {
    ...
    pub fn from_yaml_status(status: &arx::yaml::EquipmentStatus) -> Self {
        Self::new(StatusColor::from(status), format!("{:?}", status))
    }

    /// Create from core equipment status
    pub fn from_core_status(status: &arx::core::EquipmentStatus) -> Self {
        let status_color = match status {
            arx::core::EquipmentStatus::Active => StatusColor::Healthy,
            arx::core::EquipmentStatus::Maintenance => StatusColor::Warning,
            arx::core::EquipmentStatus::OutOfOrder => StatusColor::Critical,
            arx::core::EquipmentStatus::Inactive => StatusColor::Unknown,
            arx::core::EquipmentStatus::Unknown => StatusColor::Unknown,
        };
    ...
    pub fn icon_yaml(status: &arx::yaml::EquipmentStatus) -> &'static str {
        StatusColor::from(status).icon()
    }

    /// Get the icon for core equipment status
    pub fn icon_core(status: &arx::core::EquipmentStatus) -> &'static str {
        match status {
            arx::core::EquipmentStatus::Active => StatusColor::Healthy.icon(),
            arx::core::EquipmentStatus::Maintenance => StatusColor::Warning.icon(),
            arx::core::EquipmentStatus::OutOfOrder => StatusColor::Critical.icon(),
            arx::core::EquipmentStatus::Inactive => StatusColor::Unknown.icon(),
            arx::core::EquipmentStatus::Unknown => StatusColor::Unknown.icon(),
        }
    }
}
