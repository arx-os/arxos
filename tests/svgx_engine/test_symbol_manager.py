...
def sample_symbol_data(self):
    ...
    def test_list_symbols_with_filtering(self, symbol_manager, sample_symbol_data):
        ...
        electrical_symbols = symbol_manager.list_symbols(category=SymbolCategory.ELECTRICAL)
        mechanical_symbols = symbol_manager.list_symbols(category=SymbolCategory.MECHANICAL)
