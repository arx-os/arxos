...
def test_event_driven_behavior():
    ...
    try:
        ...
        print(
            f"✅ Engine initialized with {stats['processing_stats']['total_events']} events"
        )
...
def test_advanced_state_machine():
    ...
    try:
        ...
        print(
            f"✅ State machine statistics: {stats['state_stats']['total_states']} states"
        )
...
def test_conditional_logic_engine():
    ...
    try:
        ...
        print(
            f"✅ Logic engine statistics: {stats['condition_stats']['total_conditions']} conditions"
        )
...
async def test_integration():
    ...
    try:
        ...
        print(
            f"✅ Event engine: {event_stats['processing_stats']['total_events']} events"
        )
        print(f"✅ State machine: {state_stats['state_stats']['total_states']} states")
        print(
            f"✅ Logic engine: {logic_stats['condition_stats']['total_conditions']} conditions"
        )
