...
**Confirm SHA matches charter / [pilot-release.md](release.md):** [ ] Yes

---

## Rules

- Use only [l1-supported-workflow.md](supported-workflow.md) and [pilot-release.md](release.md) (no tribal knowledge from the pilot owner).  
- Time each phase.  
...
| 5 | Import **sample or pilot IFC** (`tests/fixtures/ifc/simple.ifc` from the pin checkout is OK) | 15 | | [ ] | |
...
Living plan: [horizon-b-roadmap.md](../process/horizon-b-roadmap.md) phase **HB1**.

**Related:** [l1-supported-workflow.md](supported-workflow.md) · [pilot-charter.md](charter.md) · [pilot-release.md](release.md)
