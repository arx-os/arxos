...
class TestSVGXExportInteroperabilityService:
        ...
        return {
            ...
            "svgx_elements": [
                ...
                },
                {
                    ...
                    "category": "mechanical",
                    "coordinates": [30, 40],
                    "properties": {"diameter": "12in", "flow_rate": "500cfm"},
                },
            ],
        }
    ...
    def test_export_to_ifc_lite(
        self, export_service, sample_building_data, temp_db_path
    ):
        ...
        result = export_service.export_to_ifc_lite(
            sample_building_data, options={"output_path": str(output_path)}
        )
    ...
    def test_get_export_job_status(self, export_service):
        ...
        job_id = export_service.create_export_job(
            building_id="test_building", format=ExportFormat.IFC_LITE
        )
    ...
    def test_list_export_jobs(self, export_service):
        ...
        job1 = export_service.create_export_job(
            building_id="building_1", format=ExportFormat.IFC_LITE
        )
        job2 = export_service.create_export_job(
            building_id="building_2", format=ExportFormat.GLTF
        )
    ...
    def test_export_error_handling(self, export_service, sample_building_data):
        ...
        with pytest.raises(ExportError):
            export_service.export_to_ifc_lite(
                sample_building_data, options={"invalid_option": "value"}
            )
