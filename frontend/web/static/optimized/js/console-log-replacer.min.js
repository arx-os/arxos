...
window.ConsoleLogReplacer=ConsoleLogReplacer;console.log('ConsoleLogReplacer loaded. Use ConsoleLogReplacer.getReplacementSummary() to see what needs to be replaced.');
