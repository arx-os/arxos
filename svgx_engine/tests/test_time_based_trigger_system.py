...
class TestTimeBasedTriggerSystemLogic:
    ...
    def test_pause_and_resume_trigger(self):
        # Create a trigger
        trigger = time_based_trigger_system.create_interval_trigger(
            trigger_id="pause_test", name="Pause Test Trigger", interval_seconds=60.0
        )
    ...
    def test_resume_non_paused_trigger(self):
        ...
        time_based_trigger_system.create_interval_trigger(
            trigger_id="resume_test", name="Resume Test Trigger", interval_seconds=60.0
        )
    ...
    def test_cancel_trigger(self):
        # Create a trigger
        trigger = time_based_trigger_system.create_interval_trigger(
            trigger_id="cancel_test", name="Cancel Test Trigger", interval_seconds=60.0
        )
    ...
    def test_delete_trigger(self):
        # Create a trigger
        time_based_trigger_system.create_interval_trigger(
            trigger_id="delete_test", name="Delete Test Trigger", interval_seconds=60.0
        )
    ...
    def test_get_trigger(self):
        ...
        original_trigger = time_based_trigger_system.create_interval_trigger(
            trigger_id="get_test", name="Get Test Trigger", interval_seconds=60.0
        )
    ...
    def test_get_triggers_with_status_filter(self):
        ...
        trigger1 = time_based_trigger_system.create_interval_trigger(
            trigger_id="active_trigger", name="Active Trigger", interval_seconds=60.0
        )

        trigger2 = time_based_trigger_system.create_interval_trigger(
            trigger_id="paused_trigger", name="Paused Trigger", interval_seconds=60.0
        )
    ...
    def test_get_due_triggers(self):
        ...
        trigger = time_based_trigger_system.create_one_time_trigger(
            trigger_id="due_trigger", name="Due Trigger", target_time=past_time
        )
    ...
    def test_get_execution_history(self):
        # Create a trigger
        time_based_trigger_system.create_interval_trigger(
            trigger_id="history_test", name="History Test Trigger", interval_seconds=1.0
        )
...
class TestTimeBasedTriggerSystemAsync:
    ...
    async def test_trigger_execution(self):
        ...
        trigger = time_based_trigger_system.create_one_time_trigger(
            trigger_id="async_test", name="Async Test Trigger", target_time=past_time
        )
    ...
    async def test_trigger_pause_during_execution(self):
        # Create an interval trigger
        trigger = time_based_trigger_system.create_interval_trigger(
            trigger_id="pause_async_test", name="Pause Async Test", interval_seconds=1.0
        )
...
class TestTimeBasedTriggerSystemIntegration:
    ...
    def test_trigger_calculation_methods(self):
        ...
        trigger = time_based_trigger_system.create_one_time_trigger(
            trigger_id="calc_test", name="Calculation Test", target_time=future_time
        )
