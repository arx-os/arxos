...
## Overview
Native Swift-based mobile app for interacting with Arxos building data in the field. Enables offline viewing, AR markup, object inspection, and LiDAR-based scan capture.
...
## Usage
Distributed via Apple TestFlight or App Store. Authenticates with Azure and syncs with backend.
