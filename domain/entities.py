...
class Building:
    ...
    def update_name(self, new_name: str, updated_by: str) -> None:
        ...
        self._add_domain_event(
            BuildingUpdated(
                building_id=str(self.id), updated_fields=["name"], updated_by=updated_by
            )
        )
    ...
    def _validate_status_transition(
        self, current_status: BuildingStatus, new_status: BuildingStatus
    ) -> None:
    ...
    def add_floor(self, floor: "Floor") -> None:
        ...
        if floor in self.floors:
            raise DuplicateFloorError(
                f"Floor {floor.floor_number} already exists in building"
            )
...
class Room:
    ...
    def update_name(self, new_name: str, updated_by: str) -> None:
        ...
        self._add_domain_event(
            RoomUpdated(
                building_id="",  # Would need building_id from context
    ...
    def add_device(self, device: "Device") -> None:
        ...
        if device in self.devices:
            raise DuplicateDeviceError(
                f"Device {device.device_id} already exists in room"
            )
...
class Device:
    ...
    def update_name(self, new_name: str, updated_by: str) -> None:
        ...
        self._add_domain_event(
            DeviceUpdated(
                building_id="",  # Would need building_id from context
                floor_id="",  # Would need floor_id from context
...
class User:
    ...
    def update_email(self, new_email: Email, updated_by: str) -> None:
        ...
        self._add_domain_event(
            UserUpdated(
                user_id=str(self.id), updated_fields=["email"], updated_by=updated_by
            )
        )
...
class Project:
    ...
    def update_name(self, new_name: str, updated_by: str) -> None:
        ...
        self._add_domain_event(
            ProjectUpdated(
                project_id=str(self.id), updated_fields=["name"], updated_by=updated_by
            )
        )
