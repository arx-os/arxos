...
func (s *StructureLayer) Render(viewport abim.Viewport) [][]rune {
...
func (s *StructureLayer) renderRoom(buffer [][]rune, room models.Room, vp abim.Viewport) {
...
func (s *StructureLayer) renderWalls(buffer [][]rune, vp abim.Viewport) {
...
func (s *StructureLayer) SetDirty(regions []abim.Region) {
	s.dirty = regions
}
...
func (s *StructureLayer) UpdateFloorPlan(floorPlan *models.FloorPlan) {
	...
	s.dirty = []abim.Region{{0, 0, 1000, 1000}} // Large region to force full redraw
}