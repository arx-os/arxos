...
class AuthenticationMiddleware(BaseHTTPMiddleware):
    ...
    def _load_api_keys(self) -> Dict[str, str]:
        ...
        return {"test-api-key": "test-user", "admin-api-key": "admin-user"}
...
class RateLimitingMiddleware(BaseHTTPMiddleware):
    ...
    def _check_rate_limit(self, client_id: str) -> bool:
        ...
        if client_id not in self.rate_limits:
            self.rate_limits[client_id] = {"requests": 1, "window_start": now}
            return True
    ...
    def _get_reset_time(self, client_id: str) -> int:
        ...
        client_data = self.rate_limits[client_id]
        reset_time = client_data["window_start"] + timedelta(
...
class CompressionMiddleware(BaseHTTPMiddleware):
    ...
    def _should_compress(self, response: Response) -> bool:
        ...
        return "application/json" in content_type and int(content_length) > 1024
