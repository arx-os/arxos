...
class TestRealtimeCollaboration:
    ...
    async def test_handle_join(self):
        ...
        data = {
            ...
            "username": "Test User",
            "session_id": "session1",
            "token": self.collaboration.security_manager.generate_token(
                "user1", "session1"
            ),
        }
    ...
    async def test_handle_operation(self):
        ...
        # Add user first
        user = self.collaboration.presence_manager.add_user(
            "user1", "Test User", "session1"
        )
    ...
    async def test_handle_conflict_resolution(self):
        ...
        conflict_id = conflicts[0].conflict_id
        data = {"conflict_id": conflict_id, "resolution": "last_write_wins"}
    ...
    async def test_handle_version_control(self):
        ...
        data = {"action": "create_version", "description": "Test version"}
    ...
    async def test_conflict_resolution_workflow(self):
        ...
        try:
            ...
            success = await resolve_conflict(
                "test_conflict", "last_write_wins", "user1"
            )
...
class TestErrorHandling:
    ...
    async def test_operation_without_authentication(self):
        ...
        data = {"operation_type": "create", "element_id": "element1"}
    ...
    def test_rate_limit_exceeded(self):
        ...
        for i in range(11):  # Limit is 10
            result = self.collaboration.security_manager.check_rate_limit(
