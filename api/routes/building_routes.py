...
class BuildingCreateRequest(BaseModel):
    ...
    address: str = Field(..., description="Building address", min_length=1, max_length=500)
    description: Optional[str] = Field(None, description="Building description", max_length=1000)
    ...
    total_area: Optional[float] = Field(None, ge=0, description="Total building area in square meters")
...
class BuildingUpdateRequest(BaseModel):
    ...
    name: Optional[str] = Field(None, description="Building name", min_length=1, max_length=255)
    address: Optional[str] = Field(None, description="Building address", min_length=1, max_length=500)
    description: Optional[str] = Field(None, description="Building description", max_length=1000)
