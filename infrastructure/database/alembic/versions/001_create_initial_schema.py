...
Example:
    ...
    op.create_index('idx_windows_building_floor', 'windows', ['building_id', 'floor_id'])
    ...
    op.create_index('idx_devices_building_floor', 'devices', ['building_id', 'floor_id'])
    ...
    op.create_index('idx_user_category_permissions_user_id', 'user_category_permissions', ['user_id'])
    ...
    op.create_index('idx_catalog_items_make_model_type', 'catalog_items', ['make', 'model', 'type'])
