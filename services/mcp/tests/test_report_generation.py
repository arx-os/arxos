...
class ReportGenerationTest:
    ...
    def test_report_generator(self):
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                assert os.path.exists(comprehensive_path), "Comprehensive report not generated"
                assert os.path.getsize(comprehensive_path) > 0, "Comprehensive report is empty"
    ...
    def test_report_routes(self):
        ...
        try:
            from report.report_routes import router, ReportGenerationRequest, ReportGenerationResponse
    ...
    def test_pdf_generation_quality(self):
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                logger.info(f"✅ PDF quality test passed - File size: {file_size} bytes")
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                for template_type, filename in templates:
                    ...
                    assert os.path.getsize(file_path) > 0, f"{template_type} template is empty"
