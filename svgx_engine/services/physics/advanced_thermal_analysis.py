...
class AdvancedThermalAnalysisService:
    ...
    def _initialize_advanced_materials(self) -> Dict[str, PhaseChangeMaterial]:
        ...
        return {
            ...
            "aluminum_6061": PhaseChangeMaterial(
                ...
                solid_properties={
                    "thermal_conductivity": TemperatureDependentProperty(
                        temperatures=[293.15, 373.15, 473.15, 573.15, 673.15, 773.15, 873.15],
    ...
    def _solve_non_linear_system(self, mesh: List[Dict[str, Any]], 
                                ...
                                time: float) -> Tuple[np.ndarray, Dict[str, Any]]:
        """
    ...
    def _determine_material_phases(self, materials: Dict[str, str], 
        ...
        for element_id, material_name in materials.items():
            if material_name in self.materials:
                material = self.materials[material_name]
                avg_temp = temperature[int(element_id)] if int(element_id) < len(temperature) else 293.15
    ...
    def optimize_thermal_design(self, 
                              ...
                              materials: Dict[str, str],
                              boundary_conditions: List[AdvancedBoundaryCondition],
                              objective_function: Callable[[np.ndarray, List[Tuple[float, float, float]]], float],
    ...
    def visualize_thermal_results(self, 
                                ...
                                material_phases: Dict[str, MaterialPhase] = None) -> None:
        """
