...
**Field packet (policy order):** [field-handoff.md](../pilot/field-handoff.md)  
...
| **Success** | [second-person-checklist.md](../pilot/second-person-checklist.md) signed; stuck points filed as backlog only |
...
| **Success** | Preserve/drop matrix in [field-truth-log.md](../pilot/field-truth-log.md); LossReport reviewed; export re-import notes |
...
| **Success** | ≥1 real scan session logged: false +/−, review actions, `--approved-only` export used; confidence caveats respected ([lidar-confidence.md](../reference/lidar-confidence.md)) |
...
| **Maps to** | R6 · G7 · [resource-limits.md](../reference/resource-limits.md) |
...
| **Template** | [data-classification.md](../pilot/data-classification.md) |
...
| **Steps** | See commands below; use only [l1-supported-workflow.md](../pilot/supported-workflow.md) |
...
| **Template** | [second-person-checklist.md](../pilot/second-person-checklist.md) |
...
| **Template** | [field-truth-log.md](../pilot/field-truth-log.md) §A + §A2 |
...
- [ ] [data-classification.md](../pilot/data-classification.md)  
- [ ] [pilot-release.md](../pilot/release.md) (pin table)  
- [ ] [l1-supported-workflow.md](../pilot/supported-workflow.md)  
- [ ] [second-person-checklist.md](../pilot/second-person-checklist.md)  
- [ ] [field-truth-log.md](../pilot/field-truth-log.md)  
- [ ] [ifc-limitations.md](../reference/ifc-limitations.md) (read once)  
- [ ] [resource-limits.md](../reference/resource-limits.md)  
...
| E2 | On resource refuse, print limit value + env var name + link path `docs/reference/resource-limits.md` | S3/S5 large files | Low | Tiny |
...
| 2026-07-25 | **Docs reorg:** `docs/` split into `adr/`, `reference/`, `pilot/`, `process/`, `lab/`, `_archive/`; INDEX authority hierarchy; pin baselines synced to pilot.5 where operational. |
| 2026-07-24 | **Decision 9:** interactive WASM/PWA abandoned; web = static landing; HB6 = future native iOS; PWA guides → `docs/_archive/`. |

**Related:** [INDEX.md](../INDEX.md) · [l1-supported-workflow.md](../pilot/supported-workflow.md) · [ifc-limitations.md](../reference/ifc-limitations.md) · [field-truth-log.md](../pilot/field-truth-log.md) · [resource-limits.md](../reference/resource-limits.md) · [field-handoff.md](../pilot/field-handoff.md)
