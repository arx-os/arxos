...
class TestAdvancedConflictResolution:
    ...
    @pytest.mark.asyncio
    async def test_operational_transform_create_conflict(
        self, conflict_service, sample_operations
    ):
        ...
        transformed = ot._transform_create_create(
            sample_operations["create_op"], sample_operations["create_op"]
        )
    ...
    @pytest.mark.asyncio
    async def test_operational_transform_update_conflict(
        self, conflict_service, sample_operations
    ):
    ...
    @pytest.mark.asyncio
    async def test_advanced_conflict_resolution_auto_resolve(
        self, conflict_service, sample_operations
    ):
...
class TestPushUpdatesSystem:
    ...
    async def test_event_handlers(self, push_system):
        ...
        push_system.register_event_handler(
            UpdateEventType.ELEMENT_CREATED, test_handler
        )
