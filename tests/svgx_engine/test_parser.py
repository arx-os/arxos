...
class TestSVGXParser:
    ...
    def test_parse_arx_behavior(self):
        ...
        elements_with_behavior = [
            elem for elem in elements if elem.arx_behavior is not None
        ]
    ...
    def test_parse_arx_physics(self):
        ...
        elements_with_physics = [
            elem for elem in elements if elem.arx_physics is not None
        ]
