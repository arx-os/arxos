...
class ConditionalLogicEngine:
    ...
    def register_condition(self, condition: Condition):
        ...
        logger.info(f"Registered condition {condition.condition_id} of type {condition.condition_type.value}")
    ...
    def _evaluate_threshold(self, condition: Condition, context: Dict[str, Any]) -> bool:
    ...
    def _evaluate_spatial(self, condition: Condition, context: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            min_x, max_x = bounds.get("min_x", float("-inf")), bounds.get("max_x", float("inf"))
            min_y, max_y = bounds.get("min_y", float("-inf")), bounds.get("max_y", float("inf"))
            min_z, max_z = bounds.get("min_z", float("-inf")), bounds.get("max_z", float("inf"))
    ...
    def _evaluate_relational(self, condition: Condition, context: Dict[str, Any]) -> bool:
