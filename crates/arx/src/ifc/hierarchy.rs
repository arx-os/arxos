...
impl HierarchyBuilder {
    ...
    fn extract_space_type(
        &self,
        _space: &IFCEntity,
    ) -> Result<RoomType, Box<dyn std::error::Error>> {
    ...
    fn extract_equipment_type(
        &self,
        ifc_entity_type: &str,
    ) -> Result<EquipmentType, Box<dyn std::error::Error>> {
