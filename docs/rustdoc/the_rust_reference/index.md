...
## Chapters
- [1. Notation](ch01-notation.md)
- [2. Lexical structure](ch02-lexical-structure.md)
- [3. Macros](ch03-macros.md)
- [4. Crates and source files](ch04-crates-and-source-files.md)
- [5. Conditional compilation](ch05-conditional-compilation.md)
- [6. Items](ch06-items.md)
- [7. Attributes](ch07-attributes.md)
- [8. Statements and expressions](ch08-statements-and-expressions.md)
- [9. Patterns](ch09-patterns.md)
- [10. Type system](ch10-type-system.md)
- [11. Special types and traits](ch11-special-types-and-traits.md)
- [12. Names](ch12-names.md)
- [13. Memory model](ch13-memory-model.md)
- [14. Panic](ch14-panic.md)
- [15. Linkage](ch15-linkage.md)
- [16. Inline assembly](ch16-inline-assembly.md)
- [17. Unsafety](ch17-unsafety.md)
- [18. Constant Evaluation](ch18-constant-evaluation.md)
- [19. Application Binary Interface](ch19-application-binary-interface.md)
- [20. The Rust runtime](ch20-the-rust-runtime.md)
- [21. Appendices](ch21-appendices.md)
