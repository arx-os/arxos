...
class CacheManager:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.disk_cache_enabled = self.enable_persistence and os.path.exists(self.cache_directory)
        ...
        self.logger.info(f"Cache Manager initialized (memory: {self.max_cache_size} entries, "
    ...
    def _load_persistent_cache(self):
        ...
        try:
            ...
            for cache_file in cache_files:
                ...
                metadata_path = os.path.join(self.cache_directory, cache_file.replace('.pkl', '.meta'))
    ...
    def _add_to_memory_cache(self, key: str, value: Any, size: int):
        ...
        with self._lock:
            ...
            while (len(self.memory_cache) >= self.max_cache_size or 
                   self.total_size + size > self.max_cache_memory_mb * 1024 * 1024):
...
class CachedRuleEngine:
    ...
    def validate_building_model(self, building_model, mcp_files):
        ...
        # Perform validation
        self.logger.info(f"Cache miss for building {building_model.building_id}, performing validation")
