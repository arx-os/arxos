...
from ..services.bilt_token.minting_engine_mock import MockBiltMintingEngine, VerificationResult
from ..services.bilt_token.dividend_calculator_mock import MockBiltDividendCalculator, DividendClaim
...
class MockBiltAPIRouter:
    ...
    async def distribute_dividends(self, amount: Optional[float] = None) -> MockAPIResponse:
        """
    ...
    async def claim_dividends(self, wallet_address: str) -> MockAPIResponse:
        ...
        try:
            ...
            claimable = await self.dividend_calculator.calculate_claimable_dividends(wallet_address)
    ...
    async def get_dividend_history(
        ...
        try:
            ...
            history = await self.dividend_calculator.get_dividend_history(start_dt, end_dt)
