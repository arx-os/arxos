...
def test_service_instantiation():
    ...
    instantiation_tests = [
        ("svgx_engine.services.export_integration", "SVGXExportIntegrationService", {}),
        ("svgx_engine.services.metadata_service", "SVGXMetadataService", {"cache_ttl": 300}),
        ("svgx_engine.services.bim_health", "SVGXBIMHealthCheckerService", {"db_path": ":memory:"}),
...
def test_basic_functionality():
    ...
    try:
        from svgx_engine.services.export_integration import SVGXExportIntegrationService, ScaleMetadata
