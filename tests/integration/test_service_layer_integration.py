...
from application.exceptions import (
    ...
    TransactionError, ResourceNotFoundError
)
...
def mock_metrics(self):
    ...
    @pytest.fixture
def device_service(self, mock_device_repository, mock_cache_service, mock_event_store, mock_metrics):
        ...
        return DeviceApplicationService(
            ...
            logger=Mock()
    def test_create_device_with_business_rules(self, device_service, mock_device_repository):
        ...
        with patch('application.business_rules.validate_business_rules'):
            with patch.object(device_service.create_device_use_case, 'execute', return_value=mock_response):
                # Act
    ...
    def test_create_device_business_rules_violation(self, device_service):
        ...
        with patch('application.business_rules.validate_business_rules', side_effect=BusinessRuleError(
    ...
    def test_update_device_with_transaction(self, device_service, mock_device_repository):
        ...
        with patch('application.business_rules.validate_entity_update'):
            with patch.object(device_service.update_device_use_case, 'execute', return_value=mock_response):
                # Act
    ...
    def test_delete_device_with_retry_logic(self, device_service, mock_device_repository):
        ...
        with patch.object(device_service.delete_device_use_case, 'execute', return_value=mock_response):
            # Act
    ...
    def test_assign_device_to_room(self, device_service, mock_event_store):
        ...
        with patch.object(device_service.update_device_use_case, 'execute', return_value=mock_response):
            # Act
            result = device_service.assign_device_to_room(device_id, room_id, assigned_by)
    ...
    def test_transaction_rollback_on_error(self, device_service):
        ...
        with patch.object(device_service.create_device_use_case, 'execute', side_effect=Exception("Database error")):
            # Act & Assert
    ...
    def test_business_rules_validation_integration(self):
        ...
        with pytest.raises(BusinessRuleError):
            business_rule_service.validate_entity_creation("device", invalid_device_data)
    ...
    def test_transaction_manager_integration(self):
        ...
        # Act & Assert
        try:
            result = transaction_manager.execute_in_transaction(test_operation, "test_data")
