...
Example:
    ...
    def _initialize_templates(self):
        ...
        self.templates = {
            NotificationType.DRAFT_UPDATED: NotificationTemplate(
                ...
                actions=[
                    {"label": "View Draft", "action": "view_draft", "url": "/drafts/{draft_id}"},
                    {"label": "View Changes", "action": "view_changes", "url": "/drafts/{draft_id}/changes"}
                ],
            ...
            NotificationType.COMMENT_ADDED: NotificationTemplate(
                ...
                priority=NotificationPriority.NORMAL,
                actions=[
                    {"label": "View Comment", "action": "view_comment", "url": "/drafts/{draft_id}#comment-{comment_id}"},
                    {"label": "Reply", "action": "reply_comment", "url": "/drafts/{draft_id}/comments/{comment_id}/reply"}
                ],
            ...
            NotificationType.COMMENT_REPLY: NotificationTemplate(
                ...
                actions=[
                    {"label": "View Reply", "action": "view_reply", "url": "/drafts/{draft_id}#comment-{comment_id}"},
                    {"label": "Reply", "action": "reply_comment", "url": "/drafts/{draft_id}/comments/{comment_id}/reply"}
                ],
            ...
            NotificationType.THREAD_ASSIGNED: NotificationTemplate(
                ...
                priority=NotificationPriority.HIGH,
                actions=[
                    {"label": "View Thread", "action": "view_thread", "url": "/threads/{thread_id}"},
                    {"label": "Mark Resolved", "action": "resolve_thread", "url": "/threads/{thread_id}/resolve"}
                ],
            ...
            NotificationType.MENTION: NotificationTemplate(
                ...
                priority=NotificationPriority.HIGH,
                actions=[
                    {"label": "View Mention", "action": "view_mention", "url": "/drafts/{draft_id}#comment-{comment_id}"},
                    {"label": "Reply", "action": "reply_comment", "url": "/drafts/{draft_id}/comments/{comment_id}/reply"}
                ],
            ...
            NotificationType.DRAFT_SUBMITTED: NotificationTemplate(
                ...
                priority=NotificationPriority.HIGH,
                actions=[
                    {"label": "Review Draft", "action": "review_draft", "url": "/admin/review/{draft_id}"},
                    {"label": "View Draft", "action": "view_draft", "url": "/drafts/{draft_id}"}
                ],
            ...
            NotificationType.DRAFT_APPROVED: NotificationTemplate(
                ...
                actions=[
                    {"label": "View Draft", "action": "view_draft", "url": "/drafts/{draft_id}"},
                    {"label": "Publish", "action": "publish_draft", "url": "/drafts/{draft_id}/publish"}
                ],
            ...
            NotificationType.DRAFT_REJECTED: NotificationTemplate(
                ...
                priority=NotificationPriority.HIGH,
                actions=[
                    {"label": "View Feedback", "action": "view_feedback", "url": "/drafts/{draft_id}/feedback"},
                    {"label": "Edit Draft", "action": "edit_draft", "url": "/drafts/{draft_id}/edit"}
                ],
            ...
            NotificationType.COLLABORATOR_JOINED: NotificationTemplate(
                ...
                priority=NotificationPriority.NORMAL,
                actions=[
                    {"label": "View Collaborators", "action": "view_collaborators", "url": "/drafts/{draft_id}/collaborators"}
                ],
            ...
            NotificationType.MILESTONE_REACHED: NotificationTemplate(
                ...
                priority=NotificationPriority.HIGH,
                actions=[
                    {"label": "View Milestone", "action": "view_milestone", "url": "/drafts/{draft_id}/milestones"},
                    {"label": "Release Funds", "action": "release_funds", "url": "/escrow/{draft_id}/release"}
                ],
            ...
            NotificationType.FUNDING_UPDATE: NotificationTemplate(
                ...
                priority=NotificationPriority.NORMAL,
                actions=[
                    {"label": "View Funding", "action": "view_funding", "url": "/drafts/{draft_id}/funding"}
                ],
    ...
    def create_notification_from_template(
        ...
        for action in template.actions:
            ...
            if "url" in formatted_action:
                formatted_action["url"] = formatted_action["url"].format(**template_data)
    ...
    def notify_comment_reply(
        ...
        template_data = {
            ...
            "author_id": author_id,
            "author_name": author_name,
            "reply_preview": reply_preview[:100] + "..." if len(reply_preview) > 100 else reply_preview
        }
    ...
    def notify_mention(
        ...
        template_data = {
            ...
            "author_id": author_id,
            "author_name": author_name,
            "mention_preview": mention_preview[:100] + "..." if len(mention_preview) > 100 else mention_preview
        }
    ...
    def delete_notification(self, notification_id: str, user_id: str) -> bool:
        ...
        # Remove from storage import storage
    ...
    async def send_email_notification(self, notification: Notification, user_email: str):
        ...
        try:
            ...
            self.logger.info(f"Sent email notification {notification.id} to {user_email}")
