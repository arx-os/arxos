...
def create_sample_mcp_files() -> list:
    ...
    nec_mcp = {
        ...
        "jurisdiction": {"country": "US", "state": "FL", "city": None},
        "version": "2020",
    ...
    for mcp_data, filename in [
        (nec_mcp, "nec_2020.json"),
        (ipc_mcp, "ipc_2021.json"),
        (imc_mcp, "imc_2021.json"),
    ]:
...
def run_validation_demo():
    ...
    print("\n📊 Validation Results:")
    print(
        f"   Overall Compliance Score: {compliance_report.overall_compliance_score:.1f}%"
    )
    ...
    json_content = report_generator.generate_json_report(
        compliance_report, str(json_path)
    )
