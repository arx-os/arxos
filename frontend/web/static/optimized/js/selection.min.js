class MultiSelection{constructor(){this.selectedObjects=new Set();this.isMarqueeSelecting=false;this.marqueeStart={x:0,y:0};this.marqueeElement=null;this.svgContainer=null;this.svgElement=null;this.init();}
...
document.addEventListener('DOMContentLoaded',()=>{window.multiSelection=new MultiSelection();});
