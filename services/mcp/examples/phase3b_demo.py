...
from models.mcp_models import (
    BuildingModel, BuildingObject, MCPRule, RuleCondition, RuleAction,
...
def demonstrate_rest_api():
    ...
    try:
        ...
        compliance_report = api.engine.validate_building_model(building_model_parsed, [])
...
def demonstrate_cad_integration():
    ...
    try:
        ...
        outlet = next(obj for obj in building_model.objects if obj.object_id == "outlet_bathroom_1")
        ...
        compliance_report = cad_integration.engine.validate_building_model(building_model, [])
...
def demonstrate_websocket_support():
    ...
    try:
        ...
        for client in [client1, client2]:
            print(f"📨 Client {client.client_id} received {len(client.messages)} messages")
