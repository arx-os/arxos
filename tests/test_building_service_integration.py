...
class TestArxIntegrationCLI:
    ...
    def test_run_integration_with_output_file(self, cli, tmp_path):
        ...
        # Mock the pipeline
        with patch('scripts.building_service_integration.BuildingServiceIntegrationPipeline') as mock_pipeline_class:
            mock_pipeline = Mock()
            mock_pipeline.run_complete_pipeline.return_value = {
                "pipeline_status": "completed",
                "service_name": "Test Service",
...
class TestEnterpriseCompliance:
    ...
    def test_security_compliance_validation(self):
        ...
        security_config = {
            ...
            "compliance_requirements": [
                "data_privacy", "security", "access_control"
            ],
            "performance_requirements": {
                "response_time": "< 500ms",
        ...
        risk_assessment = result.get("risk_assessment", [])
        security_risks = [risk for risk in risk_assessment if "security" in risk.get("risk", "").lower()]
