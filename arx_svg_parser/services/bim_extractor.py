...
def extract_bim_from_svg(svg_xml: str, building_id: str, floor_id: str) -> ExtractionResponse:
    """
    Extract BIM elements from SVG content.
    ...
    """
    logger.info("bim_extraction_started",
    ...
    try:
        ...
        logger.debug("svg_parsing_successful",
                    building_id=building_id,
                    floor_id=floor_id,
                    root_tag=root.tag)
    except Exception as e:
        logger.error("svg_parsing_failed",
                    building_id=building_id,
                    floor_id=floor_id,
                    error=str(e),
    ...
    def classify_system_and_type(elem: Any, parent: Any, label: str) -> (str, str):
        """Classify element by system and type based on group ID and label patterns."""
        # Default system/type
        system = 'Structural'
        type_ = 'unknown'
    ...
    for elem in root.iter():
        ...
        if system == 'E':
            ...
            logger.debug("electrical_element_extracted",
                        building_id=building_id,
                        floor_id=floor_id,
                        element_id=elem_id,
                        element_type=type_,
            ...
            logger.debug("plumbing_element_extracted",
                        building_id=building_id,
                        floor_id=floor_id,
                        element_id=elem_id,
                        element_type=type_,
            ...
            logger.debug("fire_alarm_element_extracted",
                        building_id=building_id,
                        floor_id=floor_id,
                        element_id=elem_id,
                        element_type=type_,
            ...
            logger.debug("system_element_extracted",
                        building_id=building_id,
                        floor_id=floor_id,
                        element_id=elem_id,
                        system=system,
    ...
    logger.info("bim_extraction_completed",
               building_id=building_id,
               floor_id=floor_id,
               total_elements=element_count,
               system_counts=system_counts,
               electrical_elements=system_counts.get('E', 0),
               plumbing_elements=system_counts.get('P', 0),
               fire_alarm_elements=system_counts.get('FA', 0),
               structural_elements=system_counts.get('Structural', 0))
