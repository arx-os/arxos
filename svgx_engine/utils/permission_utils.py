...
class PermissionChecker:
    ...
    def __init__(self):
        ...
        self.action_permissions = {
            ...
            PermissionAction.REPOSITORY_READ: [
            ...
            PermissionAction.REPOSITORY_WRITE: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.REPOSITORY_DELETE: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.REPOSITORY_ADMIN: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            # Building permissions
            PermissionAction.BUILDING_READ: [
                PermissionLevel.VIEWER,
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
            ...
            PermissionAction.BUILDING_WRITE: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.BUILDING_DELETE: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.BUILDING_SHARE: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ...
            PermissionAction.PROJECT_WRITE: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.PROJECT_DELETE: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.PROJECT_CREATE: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ...
            PermissionAction.ANALYTICS_EXPORT: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            # API permissions
            PermissionAction.API_READ: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ...
            # Feature permissions
            PermissionAction.FEATURE_READ: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.FEATURE_WRITE: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            # Integration permissions
            PermissionAction.INTEGRATION_READ: [
                PermissionLevel.USER,
                PermissionLevel.MANAGER,
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.INTEGRATION_WRITE: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
            PermissionAction.INTEGRATION_DELETE: [
                PermissionLevel.ADMIN,
                PermissionLevel.OWNER,
            ],
        }
        ...
        try:
            ...
            if user_role not in self.action_permissions[action]:
                self._log_permission_denied(
                    user_id, org_id, action, object_id, object_type, user_role, context
                )
                raise HTTPException(
                    status_code=status.HTTP_403_FORBIDDEN,
            ...
            if object_id and object_type:
                if not self._check_object_permission(
                    db, user_id, org_id, action, object_id, object_type, user_role
                ):
                    self._log_permission_denied(
                        user_id,
                        org_id,
    ...
    def _is_object_owner(
        self, db, user_id: int, object_id: int, object_type: str
    ) -> bool:
    ...
    def _has_org_access(
        self, db, user_id: int, org_id: int, object_id: int, object_type: str
    ) -> bool:
...
def require_permission(action: str, object_type: Optional[str] = None):
    """
