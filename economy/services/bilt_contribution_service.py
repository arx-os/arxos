...
from economy.models.contribution import (
    Contribution,
    ContributionStatus,
    ContributionLevel,
)
...
class ContributionService:
    ...
    async def create_contribution(
        ...
        logger.info(
            f"Created contribution {contribution_id} by user {user_id} for {contribution.bilt_amount} BILT"
        )
    ...
    async def verify_contribution(
        ...
        if approved_count >= 1:
            ...
            logger.info(
                f"Contribution {contribution_id} approved and {contribution.bilt_amount} BILT minted"
            )
            return True
    ...
    async def _mint_bilt(self, contribution: Contribution):
        ...
        try:
            ...
            logger.info(
                f"Minted {contribution.bilt_amount} BILT for user {contribution.user_id}"
            )
    ...
    async def get_contribution_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "approval_rate": (
                approved_contributions / total_contributions
