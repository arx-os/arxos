...
// Test fixtures for EquipmentUseCase - using shared utesting.CreateTestEquipment from testing_helpers.go
...
func TestEquipmentUseCase_GetEquipment(t *testing.T) {
	t.Run("successful retrieval", func(t *testing.T) {
		...
		testEquipment := utesting.CreateTestEquipment()
...
func TestEquipmentUseCase_UpdateEquipment(t *testing.T) {
	t.Run("successful update", func(t *testing.T) {
		...
		existingEquipment := utesting.CreateTestEquipment()
