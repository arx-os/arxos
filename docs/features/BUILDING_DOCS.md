...
```rust
// crates/arxui/crates/arxui/src/commands/doc.rs (or src/tui/docs/mod.rs)
...
```rust
// src/lib.rs or src/tui/docs/mod.rs
pub mod docs;
```
...
1. ✅ Create `src/tui/docs/mod.rs` with minimal implementation
