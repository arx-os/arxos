...
class SVGXDocument(Base):
    ...
    # Relationships
    elements: Mapped[List["SVGXElement"]] = relationship(
        "SVGXElement", back_populates="document", cascade="all, delete-orphan"
    )
    exports: Mapped[List["ExportHistory"]] = relationship(
        "ExportHistory", back_populates="document", cascade="all, delete-orphan"
    )
    collaborations: Mapped[List["CollaborationSession"]] = relationship(
        "CollaborationSession", back_populates="document", cascade="all, delete-orphan"
    )
...
class SVGXElement(Base):
    ...
    document_id: Mapped[str] = mapped_column(
        String(36), ForeignKey("svgx_documents.id"), nullable=False
    )
    ...
    # Relationships
    document: Mapped["SVGXDocument"] = relationship(
        "SVGXDocument", back_populates="elements"
    )
...
class Symbol(Base):
    ...
    # Relationships
    symbol_usage: Mapped[List["SymbolUsage"]] = relationship(
        "SymbolUsage", back_populates="symbol", cascade="all, delete-orphan"
    )
...
class SymbolUsage(Base):
    ...
    symbol_id: Mapped[str] = mapped_column(
        String(36), ForeignKey("symbols.id"), nullable=False
    )
    document_id: Mapped[str] = mapped_column(
        String(36), ForeignKey("svgx_documents.id"), nullable=False
    )
    ...
    __table_args__ = (
        ...
        UniqueConstraint(
            "symbol_id", "document_id", "element_id", name="uq_symbol_usage"
        ),
    )
...
class User(Base):
    ...
    collaboration_sessions: Mapped[List["CollaborationSession"]] = relationship(
        "CollaborationSession", back_populates="user", cascade="all, delete-orphan"
    )
    documents: Mapped[List["SVGXDocument"]] = relationship(
        "SVGXDocument", foreign_keys="SVGXDocument.created_by"
    )
...
class CollaborationSession(Base):
    ...
    # Relationships
    document: Mapped["SVGXDocument"] = relationship(
        "SVGXDocument", back_populates="collaborations"
    )
    user: Mapped["User"] = relationship("User", back_populates="collaboration_sessions")
    operations: Mapped[List["CollaborationOperation"]] = relationship(
        "CollaborationOperation", back_populates="session", cascade="all, delete-orphan"
    )
...
class CollaborationOperation(Base):
    ...
    session_id: Mapped[str] = mapped_column(
        String(36), ForeignKey("collaboration_sessions.id"), nullable=False
    )
    ...
    session: Mapped["CollaborationSession"] = relationship(
        "CollaborationSession", back_populates="operations"
    )
...
class ExportHistory(Base):
    ...
    # Relationships
    document: Mapped["SVGXDocument"] = relationship(
        "SVGXDocument", back_populates="exports"
    )
