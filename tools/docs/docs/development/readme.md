...
### Core Services
- **[arx-backend/README.md](readme.md)** - Go backend service documentation
- **[arx_svg_parser/README.md](readme.md)** - SVG parsing and BIM processing service

### Frontend Applications
- **[arx-web-frontend/README.md](readme.md)** - Web frontend application documentation

### Supporting Services
- **[arx-cmms/README.md](readme.md)** - Computerized Maintenance Management System
- **[arx-database/README.md](readme.md)** - Database schema and migrations
- **[arx-symbol-library/README.md](readme.md)** - Building symbol library

### Development Tools
- **[arx-cli/README.md](readme.md)** - Command-line interface tools
- **[arx-devops/README.md](readme.md)** - DevOps and infrastructure tools

### New Engine Development
- **[arx-svg-engine/README.md](readme.md)** - Next-generation SVG engine with geometry, physics, and BIM capabilities
