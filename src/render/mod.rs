...
use crate::core::{Equipment, Floor, Room};
...
impl BuildingRenderer {
            ...
            let health_status =
                equipment
                    ...
                    .or_else(|| match equipment.status {
                        crate::core::EquipmentStatus::Active => {
                            Some(crate::core::EquipmentHealthStatus::Healthy)
                        }
                        crate::core::EquipmentStatus::Maintenance => {
                            Some(crate::core::EquipmentHealthStatus::Warning)
                        }
                        crate::core::EquipmentStatus::Inactive
                        | crate::core::EquipmentStatus::OutOfOrder => {
                            Some(crate::core::EquipmentHealthStatus::Critical)
                        }
                        crate::core::EquipmentStatus::Unknown => {
                            Some(crate::core::EquipmentHealthStatus::Unknown)
                        }
                    });
    ...
    fn get_status_symbol_from_health(
        &self,
        health_status: Option<crate::core::EquipmentHealthStatus>,
    ) -> &str {
        match health_status {
            Some(crate::core::EquipmentHealthStatus::Healthy) => "✅",
